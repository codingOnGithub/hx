...
/**
 * 对象功能:查询过滤 Model对象 开发公司:广州宏天软件有限公司 开发人员:zxh 创建时间:2013-12-17 11:34:40
 */
public class BusQueryFilter extends BaseModel {
	...
	public String getQuery() {
		if (StringUtils.isEmpty(this.queryParameter))
			return query;
		StringBuffer sb = new StringBuffer();
		JSONArray jsonAry = JSONArray.fromObject(this.queryParameter);
		for (Object obj : jsonAry) {
			JSONObject json = JSONObject.fromObject(obj);
			sb.append("&").append(json.get("key")).append("=").append(json.get("value"));
		}
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.id, rhs.id)
				...
				.append(this.createBy, rhs.createBy).isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.id)
				.append(this.ruleId).append(this.tableName)
				.append(this.filterName).append(this.filterDesc)
				.append(this.filterKey).append(this.queryParameter)
				.append(this.sortParameter).append(this.isShare)
