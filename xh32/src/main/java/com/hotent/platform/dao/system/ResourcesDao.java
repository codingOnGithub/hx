...
public class ResourcesDao extends BaseDao<Resources>
{
	...
	public Resources getByIdAndLanType(long resId, String lanType){
		Map<String, Object> p=new HashMap<String, Object>();
		p.put("resId", resId);
		p.put("lanType", lanType);
		return (Resources)this.getOne("getByIdAndLanType", p);
	}
	...
	public List<Resources> getBySystemIdAndLanType(long systemId, String lanType){
		...
		p.put("lanType", lanType);
		return this.getBySqlKey("getBySystemIdAndLanType", p);
	}
	 ...
	 * @return
	 */
	public List<Resources> getNormMenuByRole(long systemId,Long userId,String lanType){
		Map<String, Object> p=new HashMap<String, Object>();
		p.put("systemId", systemId);
		p.put("userId", userId);
		p.put("lanType", lanType);
	 ...
	 * @return
	 */
	public List<Resources> getNormMenuByAllRole(long systemId,String rolealias,String lanType){
		Map<String, Object> p=new HashMap<String, Object>();
		p.put("systemId", systemId);
	...
	public List<Resources> getSuperMenu(Long systemId, String lanType){
		...
		p.put("systemId", systemId);
		p.put("lanType", lanType);
		return this.getBySqlKey("getSuperMenu", p);
	}
...
//	}
	...
	public List<Resources> getResourceById(long resId){
		return this.getBySqlKey("getResourceById", resId);
	}
	...
	{
	      return this.getBySqlKey("getLanguageList", new Object());
	}
	
	public void delLanResById(Long resId) {
		Map<String,Object> map=new HashMap<String, Object>();
		map.put("resId", resId);
		this.update("delLanResById", map);
	}
	
	public void addLanRes(Long resLanId,Long resId,String lanType,String lanMsg) {
		Map<String,Object> map=new HashMap<String, Object>();
		map.put("resLanId", resLanId);
		map.put("resId", resId);
		map.put("lanType", lanType);
		map.put("lanMsg", lanMsg);
		this.update("addLanRes", map);
	}
