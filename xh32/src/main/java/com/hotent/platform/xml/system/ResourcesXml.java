...
public class ResourcesXml {
	...
	@XmlElement(name = "resourcesLangList", type = ResourcesLang.class)
	private List<ResourcesLang> resourcesLangList;
	...
	public List<ResourcesLang> getResourcesLangList() {
		return resourcesLangList;
	}

	public void setResourcesLangList(List<ResourcesLang> resourcesLangList) {
		this.resourcesLangList = resourcesLangList;
	}
