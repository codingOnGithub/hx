...
//			}
	 ...
	 * @throws Exception
	 */
	public void saveUser(Integer bySelf, SysUser sysUser, Long[] aryOrgIds, Long[] posIdCharge, Long[] posIds, Long posIdPrimary, Long[] roleIds)
			throws Exception {
...
//			userPositionService.saveUserPos(userId, posIds, posIdPrimary);
			...
			//TODO 保存用户 和岗位的对应关系
			userPositionService.saveUserPos(userId, aryOrgIds, posIds, posIdPrimary,posIdCharge);
			// 保存与角色的映射关系。
