...
public class MailSetting {
	...
	private static final String MAIL_QQ="@qq.com";
	
	private static final String MAIL_163="@163.com";
	...
	public boolean getIsHandleAttach(){
		if(this.mailAddress.indexOf(this.MAIL_QQ)!=-1){
			return false;
		}else if(this.mailAddress.indexOf(this.MAIL_163)!=-1){
			return false;
		}else{
			return true;
		}
