...
public class BpmDataTemplateService extends BaseService<BpmDataTemplate> {
	...
	private JSONObject getDefaultFilterJson() {
		return JSONObject
				.fromObject("{\"name\":\""+getText("service.bpmDataTemplate.getDefaultFilterJson.name")+"\",\"key\":\"Default\",\"type\":\"1\",\"condition\":\"[]\",\"right\":[{\"s\":3,\"type\":\"everyone\",\"id\":\"\",\"name\":\"\",\"script\":\"\"}]}");
	}
	...
	public BpmFormTable getFieldListByTableId(Long tableId) {
		...
		BpmFormField field0 = this.newBpmFormField("BUS_CREATOR_ID", getText("service.bpmDataTemplate.getField.startUser"),
				BpmFormField.DATATYPE_NUMBER, FieldPool.SELECTOR_USER_SINGLE, BpmFormField.HIDDEN);
		BpmFormField field1 = this.newBpmFormField("BUS_ORG_ID", getText("service.bpmDataTemplate.getField.startOrg"),
				BpmFormField.DATATYPE_NUMBER, FieldPool.SELECTOR_ORG_SINGLE,BpmFormField.HIDDEN);
		BpmFormField field2 = this.newBpmFormField("BUS_CREATETIME",getText("service.bpmDataTemplate.getField.createTime") ,
				BpmFormField.DATATYPE_DATE, FieldPool.DATEPICKER,BpmFormField.NO_HIDDEN);
		BpmFormField field3 = this.newBpmFormField("BUS_UPDID", getText("service.bpmDataTemplate.getField.updateUser"),
				BpmFormField.DATATYPE_NUMBER, FieldPool.SELECTOR_USER_SINGLE,BpmFormField.HIDDEN);
		BpmFormField field4 = this.newBpmFormField("BUS_UPDTIME", getText("service.bpmDataTemplate.getField.updateTime"),
				BpmFormField.DATATYPE_DATE, FieldPool.DATEPICKER,BpmFormField.NO_HIDDEN);
		...
		otherTable.setTableDesc(getText("service.bpmDataTemplate.getField.tableDesc"));
	...
	public void deleteData(Long id, String pk) throws Exception {
		...
		// 删除业务表数据
		map.clear();
		map.put(bpmFormTable.getKeyDataType().shortValue() == BpmFormTable.PKTYPE_NUMBER
				.shortValue() ? BpmDataTemplate.BUS_TABLE_PK
				: BpmDataTemplate.BUS_TABLE_PK_STR, pk);
		this.deleteTable(BpmDataTemplate.BUS_TABLE, bpmFormTable, map);
