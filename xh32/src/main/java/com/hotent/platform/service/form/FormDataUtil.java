...
public class FormDataUtil {
	 ...
	 * @return
	 */
	private static Map<String, Object> caculateField(String colPrefix,  List<BpmFormField> fields,Map<String,Object> rowData){
	...
	public static Object convertType(String strValue, BpmFormField formField){
		...
		if (ColumnModel.COLUMNTYPE_DATE.equals(type)){
			...
			//替换千分位
			if("true".equals(String.valueOf(jsonObj.get("isShowComdify")))){
