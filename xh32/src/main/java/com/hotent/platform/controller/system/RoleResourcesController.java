...
public class RoleResourcesController extends BaseController
{
	...
	public void upd(HttpServletRequest request,HttpServletResponse response) throws IOException {
		...
		ResultMessage resultMessage=new ResultMessage(ResultMessage.Success,getText("controller.roleResources.success"));
		...
		try {
			...
			if (StringUtil.isNotEmpty(str)) {
				resultMessage = new ResultMessage(ResultMessage.Fail,getText("controller.roleResources.fail")+":" + str);
