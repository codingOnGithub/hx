...
public class SysCalendarController extends BaseController
{
	...
	public void del(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try{
			...
			message=new ResultMessage(ResultMessage.Success, getText("controller.sysCalendar.delete.success"));
		}
		catch(Exception ex){
			message=new ResultMessage(ResultMessage.Fail, getText("controller.sysCalendar.delete.fail")+":" + ex.getMessage());
		}
	...
	public void setDefault(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		addMessage(new ResultMessage(ResultMessage.Success,getText("controller.sysCalendar.setDefault.success")), request);
		response.sendRedirect(preUrl);
	}
