...
public class TaskCommentController extends BaseController
{
	...
	public void del(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try{
			...
			message=new ResultMessage(ResultMessage.Success, getText("record.deleted",getText("taskComment.title")));
		}
		catch(Exception ex){
			message=new ResultMessage(ResultMessage.Fail, getText("record.delete.fail",getText("taskComment.title"))+":" + ex.getMessage());
		}
	...
	public void save(HttpServletRequest request, HttpServletResponse response, TaskComment taskComment) throws Exception
	{
		...
		String result = "{\"result\":"+ResultMessage.Success
				+",\"message\":\""+getText("controller.taskComment.save.success")+"\",\"actDefId\":\""+taskComment.getActDefId()+"\""
