	...
	public void saveByOrgId(HttpServletRequest request,
		...
		try {
			...
			resultMessage = new ResultMessage(ResultMessage.Success,
					getText("record.edit",getText("sysOrgParam.title")));
			out.print(resultMessage.toString());
		} catch (Exception e) {
			e.printStackTrace();
			String str = MessageUtil.getMessage();
			if (StringUtil.isNotEmpty(str)) {
				resultMessage = new ResultMessage(ResultMessage.Fail,getText("record.edit.fail",getText("sysOrgParam.title"))+":" + str);
