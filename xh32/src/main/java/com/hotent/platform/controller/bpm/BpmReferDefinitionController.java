...
public class BpmReferDefinitionController extends BaseController
{
	...
	public void save(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try{
			if(bpmReferDefinition.getId()==null||bpmReferDefinition.getId()==0){
				...
				getText("record.added",getText("controller.bpmReferDefinition"));
				resultMsg=getText("record.added",getText("controller.bpmReferDefinition"));
			}else{
			    bpmReferDefinitionService.update(bpmReferDefinition);
				resultMsg=getText("record.updated",getText("controller.bpmReferDefinition"));
			}
	...
	public void del(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try{
			...
			message=new ResultMessage(ResultMessage.Success, getText("record.deleted",getText("controller.bpmReferDefinition")));
		}catch(Exception ex){
