...
//					"</#list>"
	...
	public void save(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			writeResultMessage(response.getWriter(),getText("controller.bpmDefRight.setRight.success"),ResultMessage.Success);
		}
		catch (Exception e) {
			String str= MessageUtil.getMessage();
			if(StringUtil.isNotEmpty(str)){
				ResultMessage resultMessage = new ResultMessage(ResultMessage.Fail, getText("controller.bpmDefRight.setRight.fail")+":" + str);
