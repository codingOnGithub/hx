...
public class SysCalendarFormController extends BaseFormController
{
	...
	public void save(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			Long id = sysCalendarService.saveCalendar(json);
			resultMessage=new ResultMessage(ResultMessage.Success, getText("controller.sysCalendar.edit.success"), String.valueOf(id));
		}
		catch(Exception ex){
			String str = MessageUtil.getMessage();
			if (StringUtil.isNotEmpty(str)) {
				resultMessage = new ResultMessage(ResultMessage.Fail,getText("controller.sysCalendar.edit.fail")+":" + str);
