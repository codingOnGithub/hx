...
public class SysTemplateController extends BaseController
{
	...
	public void del(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try {
			...
			message=new ResultMessage(ResultMessage.Success,getText("record.deleted"),getText("sysTemplate"));
		} catch (Exception e) {
	...
	public void importXml(MultipartHttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		try {
			...
			for(SysTemplate sysTemplate:sysTemplates){
				...
				MsgUtil.addMsg(MsgUtil.SUCCESS,getText("controller.sysTemplate.import.success",sysTemplate.getName()));
			}
