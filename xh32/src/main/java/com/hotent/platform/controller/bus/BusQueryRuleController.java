...
public class BusQueryRuleController extends BaseController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			writeResultMessage(response.getWriter(), getText("record.saved",getText("controller.busQueryRule.busQueryRule")),ResultMessage.Success);
		} catch (Exception e) {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		for (TableEntity tableEntity : list) {
			...
			queryRuleCounts.put(tableName,
					busQueryRuleService.getCountByTableName(tableName));
		}
	...
	public void del(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			message = new ResultMessage(ResultMessage.Success, getText("record.deleted",getText("controller.busQueryRule.busQueryRule")));
		} catch (Exception ex) {
			message = new ResultMessage(ResultMessage.Fail, getText("record.delete.fail",getText("controller.busQueryRule.busQueryRule"))+ ex.getMessage());
		}
	...
	public ModelAndView editTable(HttpServletRequest request,
		...
		return getEditView( mv,tableName);
	}
	...
	public ModelAndView edit(HttpServletRequest request,
		...
		return getEditView( getAutoView(),tableName);
	}
	
	private ModelAndView getEditView(ModelAndView mv, String tableName){
		TableEntity tableEntity = SearchCache.getTableEntityMap()
				.get(tableName);
		BusQueryRule busQueryRule = busQueryRuleService
				.getByTableEntity(tableEntity);

		return mv.addObject("busQueryRule", busQueryRule).addObject(
