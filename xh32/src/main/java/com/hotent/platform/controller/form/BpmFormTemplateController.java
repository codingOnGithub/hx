...
public class BpmFormTemplateController extends BaseController
{
	...
	{	
		...
		try{
			...
			message=new ResultMessage(ResultMessage.Success, getText("controller.bpmFormTemplate.init.success"));
		}catch(Exception ex){
			message=new ResultMessage(ResultMessage.Fail, getText("controller.bpmFormTemplate.init.fail")+":" + ex.getMessage());
		}
		addMessage(message, request);
		response.sendRedirect(preUrl);
	}
	...
	public void backUp(HttpServletRequest request,HttpServletResponse response)throws Exception
	{
		...
		try{
			...
			message=new ResultMessage(ResultMessage.Success, getText("controller.bpmFormTemplate.backUp.success"));
		}
		catch(Exception ex){
			message=new ResultMessage(ResultMessage.Fail, getText("controller.bpmFormTemplate.backUp.fail")+":" + ex.getMessage());
		}
		addMessage(message, request);
		response.sendRedirect(preUrl);
	}
	...
	{   
		...
		if(isExist){
		   writeResultMessage(response.getWriter(), new ResultMessage(ResultMessage.Fail,getText("controller.bpmFormTemplate.copyTemplate.already")));
		}else{
			...
			writeResultMessage(response.getWriter(), new ResultMessage(ResultMessage.Success, getText("controller.bpmFormTemplate.copyTemplate.success")));
		}
	}
