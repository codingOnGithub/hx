...
public class BpmDataTemplateController extends BaseController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			resultMsg = flag?getText("record.added",getText("controller.bpmTableTemplate")): getText("record.updated",getText("controller.bpmTableTemplate"));
	...
	public void del(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			message = new ResultMessage(ResultMessage.Success, getText("record.deleted",getText("controller.bpmTableTemplate")));
		} catch (Exception ex) {
			message = new ResultMessage(ResultMessage.Fail,  getText("record.delete.fail",getText("controller.bpmTableTemplate"))+ ex.getMessage());
		}
...
//TODO 数据的处理	
	...
	public ModelAndView editData(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (formKey != 0) {
			...
			String html = bpmFormHandlerService.obtainHtml(bpmFormDef, ContextUtil.getCurrentUserId(), pk, "", "", "",ctxPath);
	...
	public void exportData(HttpServletRequest request,
		...
		HSSFWorkbook wb = bpmDataTemplateService.export(id,exportIds,exportType,params);
	...
	public void importSave(MultipartHttpServletRequest request,
		...
		try {
			...
			message = new ResultMessage(ResultMessage.Success,getText("controller.importXml.success"));
		} catch (Exception e) {
			e.printStackTrace();
