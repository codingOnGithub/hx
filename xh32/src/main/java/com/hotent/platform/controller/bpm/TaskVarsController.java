...
public class TaskVarsController extends BaseController
{
	...
	public void updateTaskVars(HttpServletRequest request,HttpServletResponse response,TaskVars po) throws Exception
	{
		...
		try {
			...
			writeResultMessage(response.getWriter(), new ResultMessage(ResultMessage.Success, getText("controller.update.success")));
		} catch (Exception e) {
			String str = MessageUtil.getMessage();
			if (StringUtil.isNotEmpty(str)) {
				ResultMessage resultMessage = new ResultMessage(ResultMessage.Fail,getText("controller.taskVars.updateTaskVars.notMatch")+":" + str);
