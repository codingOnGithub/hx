...
//				sysLogSwitch.setCreatetime(new Date());
				...
				resultMsg=getText("record.added",getText("controller.sysLogSwitch"));
			}else{
				...
				resultMsg=getText("record.updated",getText("controller.sysLogSwitch"));
			}
	...
	public void del(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try{
			...
			message=new ResultMessage(ResultMessage.Success, getText("record.deleted",getText("controller.sysLogSwitch")));
		}catch(Exception ex){
