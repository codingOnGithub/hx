...
public class BpmBusLinkController extends BaseController
{
	...
	public void save(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try{
			if(bpmBusLink.getBusId()==null||bpmBusLink.getBusId()==0){
				...
				resultMsg=getText("record.added",getText("controller.bpmBusLink.bpmBusLink"));
			}else{
			    bpmBusLinkService.update(bpmBusLink);
				resultMsg=getText("record.updated",getText("controller.bpmBusLink.bpmBusLink"));
			}
	...
	public void del(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try{
			...
			message=new ResultMessage(ResultMessage.Success, getText("record.deleted",getText("controller.bpmBusLink.bpmBusLink")));
		}catch(Exception ex){
