	...
	public void saveByUserId(HttpServletRequest request,
		...
		try {
			...
			ResultMessage message = new ResultMessage(ResultMessage.Success,
					getText("record.edit",getText("sysUserParam.title")));
			out.print(message.toString());
		} catch (Exception e) {
			e.printStackTrace();
			String str = MessageUtil.getMessage();
			if (StringUtil.isNotEmpty(str)) {
				ResultMessage resultMessage = new ResultMessage(ResultMessage.Fail,getText("record.edit.fail",getText("sysUserParam.title"))+":" + str);
