...
public class SysRoleController extends BaseController {
	...
	public void del(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			delByIds(lAryId);
			message = new ResultMessage(ResultMessage.Success, getText("record.deleted",getText("sysRole.system.role")));
		} catch (Exception e) {
			message = new ResultMessage(ResultMessage.Fail, getText("record.delete.fail",getText("sysRole.system.role"))+":" + e.getMessage());
		}
	...
	public void copyRole(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (rtn) {
			writeResultMessage(writer, getText("controller.sysRole.aliasIsExist"), ResultMessage.Fail);
			return;
		}
		...
		try {
			...
			writeResultMessage(writer, getText("controller.sysRole.copeRole.success"), ResultMessage.Success);
		} catch (Exception e) {
			String str = MessageUtil.getMessage();
			if (StringUtil.isNotEmpty(str)) {
				ResultMessage resultMessage = new ResultMessage(ResultMessage.Fail,getText("controller.sysRole.copeRole.fail")+":" + str);
