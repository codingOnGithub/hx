		...
		try {
			...
			for (int i = 0; i < propertyDescriptors.length; i++) {
				...
				if (map.containsKey(propertyName)) {
					...
					if(parameterTypes[0].toString().equals(java.lang.String.class.toString())){
						args[0] =value.toString();
					}else if(parameterTypes[0].toString().equals(java.lang.Long.class.toString())){
						args[0] =Long.parseLong(value.toString());
					}else if(parameterTypes[0].toString().equals(java.lang.Integer.class.toString())){
