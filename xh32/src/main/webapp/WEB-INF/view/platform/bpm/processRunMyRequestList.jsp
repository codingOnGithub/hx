...
<title><spr:message code="processCenter.myRequest"/></title>
	...
	<div class="hide-panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="processCenter.myRequest"/></span>
			</div>
			...
			<display:table name="processRunList" id="processRunItem" requestURI="myRequestList.ht" sort="external" cellpadding="1"
				...
				<display:column titleKey="list.manage" media="html" style="width:50px;text-align:center" class="rowOps">			
					<c:if test="${processRunItem.status!=2}">
									&nbsp;<a href="javascript:;" onclick="recover(${processRunItem.runId})" class="link back"><spr:message code="menu.button.redo"/></a>
					</c:if>
				</display:column>
			</display:table>
