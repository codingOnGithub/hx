...
<div class="panel-toolbar" style="float:left;width:100%">
		<div class="panel-top-left"><spr:message code="bpmDefinition.list.title"/>->${bpmDefinition.subject }</div>
								...
								<div class="l-bar-separator"></div>
									...
									<c:choose>
										<c:when test="${not empty param.defIdForReturn}">
											<a class="link back" href="${ctx}/platform/bpm/bpmDefinition/versions.ht?defId=${param.defIdForReturn}"><span></span><spr:message code="menu.button.back"/></a>
										</c:when>
										<c:otherwise>
											<a class="link back" href="${ctx}/platform/bpm/bpmDefinition/list.ht"><span></span><spr:message code="menu.button.back"/></a>
										</c:otherwise>
									</c:choose>
									</div>
							</div>
