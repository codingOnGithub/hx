...
<title><spr:message code="processCenter.completedMatters"/></title>
	...
	<div class="hide-panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="processCenter.completedMatters"/></span>
			</div>
			...
			<div class="panel-search">
					<form id="searchForm" method="post" action="completedMattersList.ht">
							...
							<li>
								<span class="label"><spr:message code="processCenter.subject"/>:</span><input size="18" type="text" name="Q_subject_SUPL"  class="inputText"  value="${param['Q_subject_SUPL']}" />
							</li>
							<li>
								<span class="label"><spr:message code="processCenter.processName"/>:</span><input size="18" type="text" name="Q_processName_SUPL"  class="inputText"  value="${param['Q_processName_SUPL']}" />
							</li>
							<li>
		...
		<div class="panel-body">
			    ...
			    <display:table name="processRunList" id="processRunItem" requestURI="completedMattersList.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
					<display:column titleKey="list.orderNo" media="html" style="width:15px;">${processRunItem_rowNum}</display:column>
					...
					<display:column  titleKey="processCenter.endtime" sortable="true" sortName="endTime">
					...
					<display:column titleKey="processCenter.status" sortable="true" sortName="status" style="width:40px">
