...
<%@ taglib prefix="spr" uri="http://www.springframework.org/tags"%>
	<table class="table-grid">
		<thead>
		<tr>
			<th height="28"><spr:message code="task.tranTask.executionPath"/></th>
			<c:if test="${canChoicePath}">
				<th height="28"><spr:message code="task.tranTask.selectSynPath"/></th>
			</c:if>
			<th><spr:message code="task.tranTask.targetTask"/></th>
		</tr>
		</thead>		
				...
				<td>
					<c:forEach items="${nodeTranUser.nodeUserMapSet}" var="nodeUserMap">
						<div>
							...
							&nbsp;&nbsp;<a href="javascript:;" class="link grant" onclick="selExeUsers(this,'${nodeUserMap.nodeId}')"><spr:message code="menu.button.choose"/>...</a>
						</div>
					</c:forEach>
				</td> 
			</tr>
