	...
	<script type="text/javascript">
		...
		$(function() {
			function showRequest(formData, jqForm, options) { 
				...
				if(operatortype=="0"){
					$.ligerDialog.warn($lang_js.bpm.nodeButton.selectOptType,$lang.tip.msg);
					return false;
				}
				return true;
			} 
		...
		<div class="panel-body">
				<form id="bpmNodeButtonForm" method="post" action="save.ht">
						...
						<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
								<tr>
									<th width="20%"><spr:message code="bpmNodeButton.btnname"/>: </th>
									<td><input type="text" id="btnname"  name="btnname" value="${bpmNodeButton.btnname}"  class="inputText"/></td>
								</tr>
							<tr>
							<th width="20%"><spr:message code="bpmNodeButton.operatortype"/>: </th>
								<td>
							...
							<c:choose>
								<c:when test="${item.isstartform==1 }">
									<tr id="trprevscript" <c:if test="${bpmNodeButton.operatortype>1}">style="display:none"</c:if> >
										<th width="20%"><spr:message code="bpmNodeButton.prevscript"/>: </th>
									...
									<tr id="trafterscript" <c:if test="${bpmNodeButton.operatortype>1}">style="display:none"</c:if> >
										<th width="20%"><spr:message code="bpmNodeButton.afterscript"/>: </th>
										...
										<td><textarea  id="prevscript" name="prevscript" cols="50" rows="5"  class="inputText">${bpmNodeButton.prevscript}</textarea>
											<div class="tipbox">
												<a href="#" class="tipinfo">
													<span>
														<spr:message code="bpmNodeButton.simpleExample"/>简单例子：<p>var btn=$.ligerDialog.confirm(<spr:message code="bpmNodeButton.isSubmit"/>);</p>
														<p>if(btn){</p>
											...
											<br> 
											<b><spr:message code="bpmNodeButton.prevscript.help"/></b>
										</td>
									</tr>
									<tr id="trafterscript" <c:if test="${bpmNodeButton.operatortype>8}">style="display:none"</c:if> >
										...
										<td><textarea  id="afterscript" name="afterscript" cols="50" rows="5"  class="inputText">${bpmNodeButton.afterscript}</textarea>
											<div class="tipbox">
												<a href="#" class="tipinfo">
													<span>
														<spr:message code="bpmNodeButton.simpleExample"/>：<p>var btn=$.ligerDialog.confirm(<spr:message code="bpmNodeButton.isSubmit"/>);</p>
														<p>if(btn){</p>
															<p>&nbsp;&nbsp;alert("do something....");</p>
															<p>&nbsp;&nbsp;return true;</p>
														<p>}</p>
											...
											<br>
											<b><spr:message code="bpmNodeButton.afterscript.help"/></b>
										</td>
									</tr>
								</c:otherwise>
							</c:choose>
