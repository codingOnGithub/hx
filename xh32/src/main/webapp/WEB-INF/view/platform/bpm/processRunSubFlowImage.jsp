...
<title><spr:message code="processRunUserImage.title"/></title>
...
// 			loadStatus();		
	...
	function getTableHtml(taskId){		
		...
		for(var i=0;i<aryOptions.length;i++){
			...
			var status=p.status;
			var opinion=p.opinion==null ?$lang_bpm.processImage.subFlow.none : p.opinion;
			var durTime=p.durTimeStr;

			sb.append('<table class="table-task" cellpadding="0" cellspacing="0" border="0">');
			
			sb.append('<tr><th width="30%">'+$lang_bpm.processImage.subFlow.taskName+': </th>');
			sb.append('<td>'+taskName+'</td></tr>');
			
			sb.append('<tr><th width="30%">'+$lang_bpm.processImage.subFlow.exeFullname+': </th>');
			sb.append('<td>'+exeFullname+'</td></tr>');
			
			sb.append('<tr><th width="30%">'+$lang_bpm.processImage.subFlow.startTime+': </th>');
			sb.append('<td>'+startTime+'</td></tr>');
			
			sb.append('<tr><th width="30%">'+$lang_bpm.processImage.subFlow.endTime+': </th>');
			sb.append('<td>'+endTime+'</td></tr>');
			
			sb.append('<tr><th width="30%">'+$lang_bpm.processImage.subFlow.durTime+': </th>');
			sb.append('<td>'+durTime+'</td></tr>');
			
			sb.append('<tr><th width="30%">'+$lang_bpm.processImage.subFlow.status+': </th>');
			sb.append('<td>'+status+'</td></tr>');
			
			sb.append('<tr><th width="30%">'+$lang_bpm.processImage.subFlow.opinion+': </th>');
...
<body>
	<ul class="legendContainer">
		<li><div style="background-color:gray; " class="legend"></div><spr:message code="processRunUserImage.init"/></li>
		<li><div style="background-color:#00FF00;" class="legend"></div><spr:message code="processRunUserImage.agree"/></li>
		<li><div style="background-color:orange;" class="legend"></div><spr:message code="processRunUserImage.abandon"/></li>
		<li><div style="background-color:red;" class="legend"></div><spr:message code="processRunUserImage.curNode"/></li>
		<li><div style="background-color:blue;" class="legend"></div><spr:message code="processRunUserImage.notAgree"/></li>
		<li><div style="background-color:#8A0902;" class="legend"></div><spr:message code="processRunUserImage.reject"/></li>
		<li><div style="background-color:#023B62;" class="legend"></div><spr:message code="bpmRunLog.operatortype.retrieve"/></li>
		<li><div style="background-color:#338848;" class="legend"></div><spr:message code="processRunUserImage.signPassed"/></li>
		<li><div style="background-color:#82B7D7;" class="legend"></div><spr:message code="processRunUserImage.signNotPassed"/></li>
	</ul>
	<div style="padding-top:40px;background-color: white;">
		<div><spr:message code="processRunUserImage.help"/></div>
		<c:choose>
