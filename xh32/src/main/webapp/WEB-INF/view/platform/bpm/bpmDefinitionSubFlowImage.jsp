            ...
            function getItems(type) {
            	...
            	/* switch(type){
            		...
            		case "exclusiveGateway":
            			...
            			break;
            		case "multiUserTask":
            			items= [{id:'flowRule', text: $lang_bpm.bpmDefinition.nodeSet.flowRule },
            		...
            		case "userTask":
            			items= [{id:'flowRule', text:$lang_bpm.bpmDefinition.nodeSet.flowRule },
                		        ...
                		        {id:'flowForkJoin', text: $lang_bpm.bpmDefinition.nodeSet.flowForkJoin },
                		        {id:'-'},
                		        {id:'flowApproval', text: $lang_bpm.bpmDefinition.nodeSet.flowApproval },
                		        {id:'userSet', text: $lang_bpm.bpmDefinition.nodeSet.userSet } ];
            			break;
            		case "email":
            		...
            		case "script":
            			...
            			break;
            		case "callActivity":
            			items= [{id: 'viewSubFlow',text: $lang_bpm.bpmDefinition.nodeSet.viewSubFlow},
