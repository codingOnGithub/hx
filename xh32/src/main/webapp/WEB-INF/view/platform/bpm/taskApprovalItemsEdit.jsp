...
<head>
	...
	<title><spr:message code="operator.edit"/> <spr:message code="taskApprovalItems.title"/></title>
...
<div class="panel">
	<div class="panel-top">
		<div class="tbar-title">
			<span class="tbar-label"><spr:message code="taskApprovalItems.title"/></span>
		</div>
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" id="dataFormSave" onclick="save()"><span></span><spr:message code="menu.button.save"/></a></div>
				<div class="l-bar-separator"></div>
				<div class="group"><a class="link del" href="javascript:this.close()"><span></span><spr:message code="menu.button.close"/></a></div>
			</div>
		</div>
	</div>
		...
		<form id="taskApprovalItemsForm" method="post" action="save.ht">
			<div class="panel-detail">
				<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<th width="20%"><spr:message code="taskApprovalItems.isGlobal"/>: </th>
						<td><input type="checkbox" id="isGlobal" name="isGlobal" value="0" onclick="checkIsCommon(value)"/></td>
					</tr>
					<tr id="trTaskNode">
						<th width="20%"><spr:message code="taskApprovalItems.tasksNode"/>: </th>
						<td>
					...
					<tr>
						<th width="20%"><spr:message code="taskApprovalItems.approvalItem"/>: </th>
						<td>
