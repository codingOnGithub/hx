...
<head>
	...
	<title><spr:message code="menu.button.edit"/><spr:message code="reminderState.title"/></title>
				...
				<span class="tbar-label">
				  <c:choose>
						<c:when test="${reminderState.id==0}">
							<spr:message code="menu.button.add"/><spr:message code="reminderState.title"/>
						</c:when>
						<c:otherwise>
							<spr:message code="menu.button.edit"/><spr:message code="reminderState.title"/>
						</c:otherwise>
				   </c:choose> 			
				</span>
			</div>
