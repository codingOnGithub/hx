	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				...
				</c:choose>-<spr:message code="bpmDefRights.setting"/>
				</span>
			</div>
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group">
						<a class="link save"><span></span><spr:message code="menu.button.save"/></a>
					</div>
					<div class="l-bar-separator"></div>
					<c:if test="${isParent==1}">
						<div class="group">
							<input type="checkbox" id="chbIsChange" onclick="isChangeCheck()" ><spr:message code="bpmDefRights.toolbar.subTypeChange"/>
						</div>
						<div class="l-bar-separator"></div>
					</c:if>
					<div class="group"><a class="link del" onclick="window.close()" href="#"><span></span><spr:message code="menu.button.close"/></a></div>
				</div>
			</div>
		</div>
			...
			<form id="bpmDefRightsForm" action="${ctx}/platform/bpm/bpmDefRight/save.ht" method="post">
				...
				<input type="hidden"  id="isChange" name="isChange" value="0">
						...
						<table id="bpmDefRightTable"  class="table-grid table-list" cellpadding="0" cellspacing="0" border="0">
							<thead>
								<tr>
									<th width="150px;" nowrap="nowrap"><spr:message code="bpmDefRights.list.rightsType"/></th>
									<th style="text-align: center;"><spr:message code="bpmDefRights.list.licensedTo"/></th>
									<th  width="180px;" nowrap="nowrap"  style="text-align: center;"><spr:message code="list.choose"/></th>
								</tr> 
							</thead>
								<tr>
									<th colspan="3"> 
										<input id="selectAll" style="float:left" type="checkbox" onclick="selectAllHandler(this)"> <label style="float:left"  for="selectAll"><spr:message code="bpmDefRights.list.allowAccess"/></label>
									</th>
								</tr>
								<tr style="display: none">
									<td><spr:message code="bpmDefRights.list.allUsers"/></td>
									<td>
								...
								<tr>
									<td><spr:message code="bpmDefRights.list.userAuthorize"/></td>
									<td>
										<div class="owner-div"></div>
									...
									<td>
										<a class="current" onclick="chooseUser(this);" ><span></span><spr:message code="menu.button.choose"/>...</a>
										<a class="current" onclick="resetSelect(this);" ><span></span><spr:message code="menu.button.reset"/></a>
									</td>
								</tr>
								<tr>
									<td><spr:message code="bpmDefRights.list.roleAuthorize"/></td>
									<td>
										<div class="owner-div"></div>
									...
									<td>
										<a class="current" onclick="chooseRole(this);" ><span></span><spr:message code="menu.button.choose"/>...</a>
										<a class="current" onclick="resetSelect(this);" ><span></span><spr:message code="menu.button.reset"/></a>
									</td>
								</tr>
								<tr>
									<td><spr:message code="bpmDefRights.list.orgAuthorize"/></td>
									<td>
										<div class="owner-div"></div>
									...
									<td>
										<a class="current" onclick="chooseOrg(this);" ><span></span><spr:message code="menu.button.choose"/>...</a>
										<a class="current" onclick="resetSelect(this);" ><span></span><spr:message code="menu.button.reset"/></a>
									</td>
								</tr>
								<tr>
									<td><spr:message code="bpmDefRights.list.subOrgAuthorize"/></td>
									<td>
										<div class="owner-div"></div>
								...
								<tr>
									<td><spr:message code="bpmDefRights.list.positionAuthorize"/></td>
									<td>
										<div class="owner-div"></div>
									...
									<td>
										<a class="current" onclick="choosePosition(this);" ><span></span><spr:message code="menu.button.choose"/>...</a>
										<a class="current" onclick="resetSelect(this);" ><span></span><spr:message code="menu.button.reset"/></a>
									</td>
								</tr>
						</table>
