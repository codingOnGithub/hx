...
<title><spr:message code="bpmDefinition.copyUser.title"/></title>
	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="bpmDefinition.copyUser.title"/></span>
			</div>
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link save" onclick="saveCcMessageType()"><span></span><spr:message code="menu.button.save"/></a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link add" onclick="conditionDialog()"><span></span><spr:message code="menu.button.add"/></a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link update" onclick="editCondition()"><span></span><spr:message code="menu.button.edit"/></a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link del" onclick="delCondition()"><span></span><spr:message code="menu.button.del"/></a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link save" onclick="saveGroupNo(this)" id="btnSaveGroupNo" ><span></span><spr:message code="menu.button.saveGroupNo"/></a></div>
				</div>
			</div>
		</div>
		<div class="panel-body">
			<table class="table-grid" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<th width="20%" nowrap="nowarp"><spr:message code="bpmDefinition.copyUser.globalMessageType"/>: </th>
					<td>
						<label><input class="send_type" name="inner" type="checkbox"  checked="checked"/><spr:message code="message.inner"/></label>
						<label><input class="send_type" name="mail" type="checkbox"  checked="checked"/><spr:message code="message.mail"/></label>
						<label><input class="send_type" name="sms" type="checkbox" /><spr:message code="message.sms"/></label>
					</td>
				</tr>
			</table>
		</div>
				...
				<thead>
					<tr>
						<th width="5%" nowrap="nowrap">
							<label><input type="checkbox" id="chkall" /><spr:message code="list.orderNo"/></label>							
						</th>
						<th width="40%"><spr:message code="bpmDefinition.copyUser.ruleDesc"/></th>
						<th width="35%"><spr:message code="bpmDefinition.copyUser.userDesc"/></th>
						<th width="80" nowrap="nowrap"><spr:message code="bpmDefinition.copyUser.sn"/></th>
						<th width="90px" nowrap="nowrap"><spr:message code="bpmDefinition.copyUser.groupNo"/></th>
					</tr>
				</thead>
				<tbody class="data">
