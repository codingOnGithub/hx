...
<head>
	...
	<title><spr:message code="bpmNodeUser.preview"/></title>
...
<body style="overflow-x: hidden;">
	<div class="panel">
		<div class="hide-panel">
			<div class="panel-top">
				...
				<div class="panel-toolbar">
					<div class="toolBar">
						<div class="group"><a class="link search" id="btnSearch"><span></span><spr:message code="menu.button.preview"/></a></div>
		...
		<div class="panel-body">
			<div id="tabPreView">
				<div  title="<spr:message code='bpmNodeUser.preview.param'/>">
					<table  class="table-detail">
			   			<thead>
			   				<tr>
			   					<th><spr:message code="bpmNodeUser.preview.paramName"/></th>
			   					<th><spr:message code="bpmNodeUser.preview.paramValue"/></th>
			   				</tr>
			   			</thead>
		   		...
		   		<div title="<spr:message code='bpmNodeUser.preview.result'/>" id="divResult">
		...
		<#if (item.type==1)>
			<tr>
				...
				<td>
					...
					<a class="button" onclick="selectExecutor(this,1)"><span class="chosen"><spr:message code="menu.button.choose"/></span></a>
				</td>
			</tr>
		<#elseif (item.type==2)>
			<tr>
		...
		<#elseif (item.type==3)>
			<tr>
				...
				<td>
					...
					<a class="button" onclick="selectExecutor(this,2)"><span class="chosen"><spr:message code="menu.button.choose"/></span></a>
				</td>
			</tr>
		<#elseif (item.type==4)>
			<tr>
				...
				<td>
					...
					<a class="button" onclick="selectExecutor(this,3)"><span class="chosen"><spr:message code="menu.button.choose"/></span></a>
				</td>
			</tr>
			<%--职务 --%>
		<#elseif (item.type==5)>
			<tr>
				...
				<td>
					...
					<a class="button" onclick="selectExecutor(this,7)"><span class="chosen"><spr:message code="menu.button.choose"/></span></a>
				</td>
			</tr>	
		<#elseif (item.type==6)>
			<tr>
				...
				<td>
					...
					<a class="button" onclick="selectExecutor(this,4)"><span class="chosen"><spr:message code="menu.button.choose"/></span></a>
				</td>
			</tr>
		<#elseif (item.type==7)>
			<tr>
				...
				<td>
					...
					<a class="button" onclick="selectExecutor(this,5)"><span class="chosen"><spr:message code="menu.button.choose"/></span></a>
				</td>
			</tr>
		<#elseif (item.type==8)>
			<tr>
				...
				<td>
					...
					<a class="button" onclick="selectExecutor(this,6)"><span class="chosen"><spr:message code="menu.button.choose"/></span></a>
				</td>
			</tr>
		<#elseif (item.type==9)>
			<tr>
