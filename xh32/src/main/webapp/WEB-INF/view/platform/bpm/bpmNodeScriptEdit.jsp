				...
				<form id="bpmNodeScriptForm" method="post" action="save.ht">
					<div id="tabScript" >
						<c:if test="${type eq 'startEvent' || type eq 'subProcess' || type eq 'subStartEvent' }">
							<div tabid="startEvent" title="<spr:message code="bpmNodeScript.startScript"/>">
						...
						<c:if test="${type eq 'endEvent' || type eq 'subProcess'}">
							<div tabid="endEvent" title="<spr:message code="bpmNodeScript.endScript"/>">
								<table class="table-detail" cellpadding="0" cellspacing="0" border="0"  >
									<tr>
										<th width="20%"><spr:message code="tip.explanation"/>:<span class="required">*</span> </th>
										<td>
						...
						<c:if test="${type eq 'script' }">
							<div tabid="ScriptNode" title="<spr:message code="bpmNodeScript.scriptCode"/>">
