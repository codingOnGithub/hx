...
<body>
	<div id="defLayout">
			<div position="center" style="height:580px;">
				<div id="refer-div">
					<table class="table-detail">
						<tr>
							<th width="20%"><spr:message code="bpmDefinition.defRefer.title"/>:</th>
							<td>
								<select id="selectRefer"  style="min-width: 100px">
									<option value="0" selected="selected">--<spr:message code="search.select.pleaseSelect"/>--</option>
			...
			<div position="bottom"  class="bottom" style="height:30px;" >
				<a href="#" id="btnSelect" class="button" onclick="selectInst()" style="margin-right:10px;" ><span class="icon ok"></span><span class="chosen"><spr:message code="menu.button.choose"/></span></a>
				<a href="#" class="button"  onclick="clearInst()"><span class="icon cancel" ></span><span class="chosen" ><spr:message code="menu.button.empty"/></span></a>
				<a href="#" id="btnClose"  class="button"  onclick="window.close()" style="margin-left:10px;" ><span class="icon cancel" ></span><span class="chosen" ><spr:message code="menu.button.cancel"/></span></a>
			</div>
		</div>
	</div>
