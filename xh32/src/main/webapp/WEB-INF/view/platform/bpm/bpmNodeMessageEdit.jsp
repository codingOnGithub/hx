...
<head>
	...
	<title><spr:message code="bpmNodeMessage.title"/></title>
	...
	<script type="text/javascript">
		...
		function handFlowVars(){
			$("select[name='selFlowVar']").change(function(){	
				...
				if ( oEditor.mode == 'wysiwyg' ){
					...
					alert( '<spr:message code="bpmNodeMessage.editMode"/>' );
			});
		}
		...
		function getTokensFromConditions(conds){
			...
			for(var i=0;i<conds.length;i++){
				var id = conds[i].id;
				var name = '<spr:message code="bpmNodeMessage.No"/>'+"["+conds[i].groupNo+"] - "+conds[i].conditionShow;
	     ...
	     function validata(){
	    	 ...
	    	 if(isFlag){
	    		 $.ligerDialog.warn('<spr:message code="bpmNodeMessage.setParameters"/>',$lang.tip.msg);
	    		 return false;
	    	 }
	    	 var mailDatas = $("#receiver_mail").tokenInput("get");
	    	 if(mailDatas && mailDatas.length>0){
	    		 if($("#subject_mail").val()==""){
    				 $.ligerDialog.warn('<spr:message code="bpmNodeMessage.inputMailSubject"/>',$lang.tip.msg);
    				 return false;
       			}
	    	 }else{
	    		 if($("#subject_mail").val()!=""){
	    			 $.ligerDialog.warn('<spr:message code="bpmNodeMessage.inputMailReceiver"/>',$lang.tip.msg);
    				 return false;
	    		 }
	    	 }
	    	 ...
	    	 if(innerDatas && innerDatas.length>0){
	    		 if($("#subject_inner").val()==""){
	    			 $.ligerDialog.warn('<spr:message code="bpmNodeMessage.inputInnerSubject"/>',$lang.tip.msg);
    				 return false;
    			}
	    	 }else{
	    		 if($("#subject_inner").val()!=""){
	    			 $.ligerDialog.warn('<spr:message code="bpmNodeMessage.inputInnerReceiver"/>',$lang.tip.msg);
    				 return false;
	    		 }
	    	 }
		 	...
		 	$.post(url,param,function(data){
			 	if(!data.status){
					...
					$(tokenData).each(function(){
				 	...
				 	$.ligerDialog.error('<spr:message code="bpmNodeMessage.reloadError"/>',$lang.tip.msg);
			 	}
		 	});
		};
		...
		function deleteBpmUserCondition(data){
			...
			$.post(url,{id:id},function(t){
				...
				if(!resultData.result){
					$.ligerDialog.error('<spr:message code="bpmNodeMessage.deleteError"/>',$lang.tip.msg);
					reloadToken(type);
				}
			});
		};
...
<body>
			...
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="bpmNodeMessage.title"/></span>
			</div>
		...
		<form id="bpmNodeMessageForm" method="post" action="save.ht">
			<div class="panel-detail">
					...
					<div class="foldBox">
					<div class="title" >
					         <spr:message code="message.mailContent"/>
					   </div>
					 <div class="content" >
					 
					 <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.send"/>: </th>
							<td><input type="checkbox" id="sendMail" name="sendMail"  value="1" <c:if test="${mailMessage.isSend==1}">checked="checked"</c:if> /></td>
						</tr>
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.subject.mail"/>: </th>
						...
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.receiver.mail"/>: </th>
							<td valign="top">
					        ...
					        <a href="#" onclick="receiverSetting(3)" class="link edit"><spr:message code="menu.button.setting"/></a>
							</td>
						</tr>
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.copyTo.mail"/>: </th>
							<td>
							...
							<a href="#" onclick="receiverSetting(4)" class="link edit"><spr:message code="menu.button.setting"/></a>
							</td>
						</tr>
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.bcc.mail"/>: </th>
							<td>
							...
							<a href="#" onclick="receiverSetting(5)" class="link edit"><spr:message code="menu.button.setting"/></a>
							</td>
						</tr>					
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.template.mail"/>: </th>
							<td>
								<div>	
								<spr:message code="bpmNodeMessage.formVar"/>:<f:flowVar defId="${defId}" controlName="selFlowVar"></f:flowVar>
								<a href="#"  class="link var" title="<spr:message code='bpmNodeMessage.tempCon'/>" onclick="slectTemplate('template_mail',false)"><spr:message code="bpmNodeMessage.tempCon"/></a>
								</div>
		          ...
		          <div class="foldBox">
				  	<div class="title" >
						<spr:message code="message.innerContent"/>
					  </div>
					<div class="content" >
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						<tr>
						...
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.subject.inner"/>: </th>
						...
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.receiver.inner"/>: </th>
							<td valign="top">
							...
							<a href="#" onclick="receiverSetting(6)" class="link edit"><spr:message code="menu.button.setting"/></a>
							</td>
						</tr>									
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.template.inner"/>: </th>
							<td>
								<div>	
								<spr:message code="bpmNodeMessage.formVar"/>:<f:flowVar defId="${defId}" controlName="selFlowVar"></f:flowVar>
								<a href="#"  class="link var" title="<spr:message code='bpmNodeMessage.tempCon'/>" onclick="slectTemplate('template_inner',false)"><spr:message code="bpmNodeMessage.tempCon"/></a>
					         	</div>
					...
					<div class="foldBox">
					<div class="title" >
					      <spr:message code="message.smsContent"/>
					   </div>
					 <div class="content" >
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">						
						<tr>
						...
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.receiver.mobile"/>: </th>
							<td valign="top">
							...
							<a href="#" onclick="receiverSetting(7)" class="link edit"><spr:message code="menu.button.setting"/></a>
							</td>
						</tr>								
						<tr>
							<th width="20%"><spr:message code="bpmNodeMessage.template.mobile"/>: </th>
							<td>
							<div>
							<a href="#"  class="link var" title="<spr:message code='bpmNodeMessage.tempCon'/>" onclick="slectTemplate('template_mobile',true)"><spr:message code="bpmNodeMessage.tempCon"/></a>	
					         </div>
