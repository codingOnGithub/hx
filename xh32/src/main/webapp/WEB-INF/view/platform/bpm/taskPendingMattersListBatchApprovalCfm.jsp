...
<title><spr:message code="processCenter.batchApproval"/></title>
	...
	<div class="hide-panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="processCenter.batchApproval"/></span>
			</div>
		</div>
		</div>
		<div class="panel-body">
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link save" id="dataFormSave" href="#" onclick="save()"><span></span><spr:message code="menu.button.approval"/></a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link close"  href="#" onclick="window.close();"><span></span><spr:message code="menu.button.close"/></a></div>
				</div>
			</div>
			<form id="frmApprove">
				<div  class="row"><span class="label" style="font-weight: bold;"><spr:message code="processCenter.approvalOpinion"/>：</span></div>
				<div class="row">
