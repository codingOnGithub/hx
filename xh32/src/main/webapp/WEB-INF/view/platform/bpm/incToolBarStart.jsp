	...
	<div class="hide-panel">
		<div class="panel-top">
			<div class="tbar-title noprint">
				<span class="tbar-label"><spr:message code="bpmNodeButton.startProcess"/>--${bpmDefinition.subject} --V${bpmDefinition.versionNo}</span>
			</div>
				...
				<div class="toolBar">
					...
					<c:choose>
						<c:when test="${empty mapButton }">
							<div class="group"><a class="link run"><span></span><spr:message code="bpmNodeButton.submit"/></a></div>
							<c:choose>
								<c:when test="${isDraft}">
									<div class="l-bar-separator"></div>
									<div class="group"><a class="link save isDraft"><span></span><spr:message code="bpmNodeButton.button.saveDraft"/></a></div>
								</c:when>
								<c:otherwise>
									<div class="l-bar-separator"></div>
									<div class="group"><a class="link save"><span></span><spr:message code="bpmNodeButton.button.saveData"/></a></div>
								</c:otherwise>
							</c:choose>
							<div class="l-bar-separator"></div>
							<div class="group"><a class="link reset"><span></span><spr:message code="menu.button.reset"/></a></div>
							<div class="l-bar-separator"></div>
							<div class="group"><a class="link flowDesign" onclick="showBpmImageDlg()"><span></span><spr:message code="bpmNodeButton.button.image"/></a></div>
