...
<html>
    ...
    <body>
      	<div id="defLayout" >            
            <div position="left" title="<spr:message code='bpmDefinition.type.title'/>" style="overflow: auto;float:left;width:100%">
            ...
            <div position="center" title="<spr:message code='bpmDefinition.export.bpmDefinition'/>">
            ...
            <c:if test="${param.isSingle==false}">
				<div   position="right" title="   <a onclick='javascript:dellAll();' class='link del'><spr:message code='menu.button.empty'/> </a><input type='text' class='quick-find' title='<spr:message code='menu.button.search'/>'/> " style="overflow-y: auto;">
		...
		<div position="bottom" class="bottom" style='margin-top:10px;'>
		  	<a href='#' class='button'  onclick="selectFlow()" ><span class="icon ok"></span><span ><spr:message code="menu.button.choose"/></span></a>
