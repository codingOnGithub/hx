...
<title><spr:message code="processRun.redo.title"/></title>
...
$(function(){
	 $("a.save").click(function(){	
		 if($.isEmpty( $('#opinion').val())){
			 $.ligerDialog.warn($lang_bpm.recover.redoOpinion,$lang.tip.msg);
			 $('#opinion').focus();
			 return;
		 }
		 $.ligerDialog.confirm($lang_bpm.recover.redoConfirm,$lang.tip.msg,callBack);
	 });
})
</script>
</head>
	...
	<div class="panel">
		...
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="processRun.redo.title"/></span>
			</div>
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link save" id="dataFormSave" href="#"><span></span><spr:message code="menu.button.redo"/></a></div>
		...
		<div class="panel-body">
			<form id="frmRecover">
				<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<th><spr:message code="processRun.redo.opinion"/>:</th>
						<td>
