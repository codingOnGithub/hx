   	...
   	<div id="defLayout" class="panel-top">
         <div position="left" title="<spr:message code='bpmDefinition.type.title'/>" style="overflow: auto;float:left;width:100%">
         	<div class="tree-toolbar">
				<span class="toolBar">
						<div class="group"><a class="link reload" id="treeFresh" href="javascript:globalType.loadGlobalTree();"  title="<spr:message code='res.reflash'/>"></a></div>
						<div class="l-bar-separator"></div>
						<div class="group"><a class="link expand" id="treeExpandAll" href="javascript:treeExpandAll(true)"  title="<spr:message code='res.expand'/>"></a></div>
						<div class="l-bar-separator"></div>
						<div class="group"><a class="link collapse" id="treeCollapseAll" href="javascript:treeExpandAll(false)"  title="<spr:message code='res.coll'/>"></a></div>
				</span>
			</div>
