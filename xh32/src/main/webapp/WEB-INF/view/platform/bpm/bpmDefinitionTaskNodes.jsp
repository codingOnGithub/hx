		...
		<div class="hide-panel">
			<div class="panel-top">
				...
				<div class="panel-toolbar">
					<div class="toolBar">
						<div class="group"><a class="link save" onclick="selectTaskNode()"><span></span><spr:message code="menu.button.choose"/></a></div>
		...
		<div class="panel-body">
			<table cellpadding="1" cellspacing="1"  class="table-grid">
				<thead>
					<tr>
						<th width="120">
							<spr:message code="bpmNodeUser.taskNode.No"/>
						</th>
						<th>
							<spr:message code="bpmNodeUser.taskNode.nodeName"/>
						</th>
					</tr>
				</thead>
