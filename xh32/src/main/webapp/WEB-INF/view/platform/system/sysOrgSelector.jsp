	...
	<div class="panel">
		<div class="panel-search">
				<form action="selector.ht?" id="searchForm" method="POST" target="orgFrame">
					<div class="row">
						...
						<span class="label"><spr:message code="sysOrg.orgName"/>:</span> 
	    ...
	    <c:if test="${isSingle==false}">
		 ...
		 <display:table name="sysOrgList" id="sysOrgItem" requestURI="selector.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
			...
			<display:column property="orgName" titleKey="sysOrg.orgName" sortable="true" sortName="orgName" ></display:column>
			<display:column property="orgPathname" titleKey="sysOrg.path"  sortable="true" sortName="orgPathname" maxLength="250" ></display:column>
		</display:table>
