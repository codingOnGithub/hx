...
<html>
	<head>
		...
		<title><spr:message code="positionJob.selector.title"/></title>
		...
		<script type="text/javascript">
			...
			function selectJob(){
				var pleaseSelect= $lang_selector.sysRole.pleaseSelect;
				//单选
				if(isSingle==true){
					var chIds = $('#jobFrame').contents().find("input[name='jobid']:checked");
					if(chIds.length==0){
						alert($lang_selector.pleaseSelect);
						return;
					}
					var data=chIds.val();
	...
	<body >
		<div id="defLayout" >
				 ...
				 <%-- 
       	         <div position="left" title="<spr:message code='subSystem'/>" style="height:95%;">
		...
		<div position="bottom"  class="bottom" style="margin-top:10px;" >
		      	<a href="#" class="button"  onclick="selectJob()" style="margin-right:10px;" ><span class="icon ok"></span><span class="chosen"><spr:message code="menu.button.choose"/></span></a>
				<a href="#" class="button"  onclick="clearJob()"><span class="icon cancel" ></span><span class="chosen" ><spr:message code="menu.button.empty"/></span></a>
				<a href="#" class="button"  onclick="window.close()" style="margin-left:10px;" ><span class="icon cancel" ></span><span class="chosen" ><spr:message code="menu.button.cancel"/></span></a>
