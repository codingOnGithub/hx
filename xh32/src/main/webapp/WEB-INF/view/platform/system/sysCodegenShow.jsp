...
<body>
	<div id="layout" style="bottom: 1; top: 1">
		<div position="left" title="<spr:message code="sysCodegen.customTable"/>" id="TreeManage"
			style=" height: 95%; width: 100% !important;">
			<div style="width: 100%;">
					<input type="text" name="subject" id="subject" style="width:75%;"><a class="link search" id="treeSearch"><spr:message code="menu.button.search"/></a>
			</div>
		...
		<div position="center" id="tableView" style="height: 100%;">
			<div class="l-layout-header" ><spr:message code="sysCodegen.codeConfig"/></div>
