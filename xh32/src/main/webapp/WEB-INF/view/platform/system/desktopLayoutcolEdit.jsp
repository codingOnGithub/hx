...
<head>
	...
	<title><spr:message code="desktopLayoutcol.edit.title" /></title>
			...
			<div class="tbar-title">
			    <c:choose>
			        <c:when test="${desktopLayoutcol.id !=null }">
			            <span class="tbar-label"><spr:message code="desktopLayoutcol.edit.span.edit" /></span>
			        </c:when>
			        <c:otherwise>
			            <span class="tbar-label"><spr:message code="desktopLayoutcol.edit.span.add" /></span>
			        </c:otherwise>
			    </c:choose>					
			</div>
				...
				<form id="desktopLayoutcolForm" method="post" action="save.ht">
					<div class="panel-detail">
						<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<th width="20%"><spr:message code="desktopLayoutcol.columnId" />:</th>
								<td>
							...
							<tr>
								<th width="20%"><spr:message code="desktopLayoutcol.layoutId" />: </th>
								<td>
							...
							<tr>
								<th width="20%"><spr:message code="desktopLayoutcol.col" />: </th>
								<td><input type="text" id="col" name="col" value="${desktopLayoutcol.col}"  class="inputText"/></td>
							</tr>
							<tr>
								<th width="20%"><spr:message code="desktopLayoutcol.sn" />: </th>
