...
<title><spr:message code="conditionScript"/><spr:message code="conditionScript.addDialog.title"/></title>
...
<div class="panel">
	<div class="panel-top">
		<div class="tbar-title">
			 <span class="tbar-label"><spr:message code="conditionScript"/><spr:message code="conditionScript.addDialog.title"/></span>
		</div>
	...
	<div class="panel-body">
		<form id="ruleConditionScriptForm">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				<tr>
					<th><spr:message code="conditionScript"/>:</th>
					<td>
						...
						<a class="link detail" onclick="selectConditionScript(this)"><spr:message code="operator.select"/></a>
					</td>
				</tr>
			</table>
			...
			<table class="table-detail para-info-table" cellpadding="0" cellspacing="0" border="0">
				<thead>
					<tr>
						<th width="10%"><spr:message code="conditionScript.argument.name"/></th>
						...
						<th  colspan="3"><spr:message code="conditionScript.argument.value"/></th>
					</tr>
				</thead>
				<tbody>
				</tbody>
			...
			<tr class="param-tr-template param-tr">
				...
				<td>
					<select name="paraValType" onchange="paraValTypeChange(this)">
						<option value="1"><spr:message code="conditionScript.argument.value.flowVar"/></option>
						<option value="2"><spr:message code="conditionScript.argument.value.fix"/></option>
					</select>
				</td>
				<td>
				</td>
