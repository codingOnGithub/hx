...
<title>WEB服务数据模板<spr:message code="operator.edit"/></title>
<style type="text/css">
	html,body{
		overflow:auto;
	}
	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">WEB服务数据模板<spr:message code="operator.edit"/></span>
			</div>
			...
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">				 
				...
				<tr>
					...
					<td>
						...
						<thead>
							<tr>
								<th width="25%"><spr:message code="WebService.argument.name"/></th>
								<th width="20%"><spr:message code="WebService.argument.type"/></th>
								<th width="30%"><spr:message code="WebService.argument.value"/></th>
							</tr>
						</thead>
						<tbody id="paraInfo">
						</tbody>
	...
	<div class="hidden">
		<textarea id="param_tr">
			...
			<tr>
				...
				<#if (obj.javaType == 1)>
				<td><spr:message code="WebService.argument.type.string"/></td>
				<td>
					<input type="text" name="testVal" validate="{required:true}"/>
				</td>
				<#elseif (obj.javaType == 2)>
				<td><spr:message code="WebService.argument.type.number"/></td>
				<td>
					<input type="text" name="testVal" validate="{required:true}"/>
				</td>
				<#else>
				<td><spr:message code="WebService.argument.type.date"/></td>
				<td>
