...
<head>
	...
	<title><spr:message code="sysOrgParam.title"/><spr:message code="title.manage"/></title>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("a.save").click(function() {
				var orgId=$("#orgId").val();
				if(orgId==null){
					$.ligerDialog.warn($lang_system.sysOrg.param.noselect);
				}else{
			...
			function showResponse(responseText, statusText)  { 
				...
				if(obj.isSuccess()){//成功
			    	...
			    	$.ligerDialog.err($lang.tip.error,$lang_system.sysOrg.param.saveFail,obj.getMessage());
			    }
			} 
			...
			<div class="panel">
				<div class="panel-top">
					<div class="tbar-title">
						<span class="tbar-label">【${sysOrg.orgName }】<spr:message code="sysOrgParam.title"/><spr:message code="title.manageList"/></span>
					</div>
				...
				<div class="panel-body">
				    	...
				    	<table id="sysParamItem" cellpadding="1" cellspacing="1"  class="table-grid">
								<head>
									...
									<th style="text-align: center;"><spr:message code="sysOrgParam.paramName"/></th>
									<th style="text-align: center;"><spr:message code="sysOrgParam.paramValue"/></th>
