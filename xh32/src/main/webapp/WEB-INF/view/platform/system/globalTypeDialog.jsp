...
<title><spr:message code="globalType"/><spr:message code="title.manage"/></title>
...
<body>
	<div class="panel-top">
				<div class="tbar-title">
					<span class="tbar-label"><c:choose><c:when test="${isAdd}"><spr:message code="title.add"/><spr:message code="globalType"/></c:when><c:otherwise><spr:message code="title.update"/><spr:message code="globalType"/></c:otherwise></c:choose></span>
				</div>
		...
		<form id="globalTypeForm" method="post" action="save.ht">
				<div class="panel-detail">
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							...
							<c:if test="${isDict}">
							<tr>
								<th width="20%"><spr:message code="globalType.nodeCodeType"/>:</th>
								<td >
