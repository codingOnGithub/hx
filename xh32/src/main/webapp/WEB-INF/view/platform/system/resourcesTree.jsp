...
<title><spr:message code="resources"/><spr:message code="title.manageList"/></title>
...
<script type="text/javascript">
	...
	function loadMenu(){
        ...
        [{ text: $lang_system.resources.tree.text_menu_add, click: addNode },
        { text: $lang_system.resources.tree.text_menu_edit, click: editNode  },
        { text: $lang_system.resources.tree.text_menu_del, click: delNode },
        { text: $lang_system.resources.tree.text_menu_import, click: importXml },
        { text: $lang_system.resources.tree.text_menu_export, click: exportXml },
		{ text: $lang_system.resources.tree.text_menu_sort, click: sortNode },
		{ text: $lang_system.resources.tree.text_menu_move, click: moveNode }]
        });
        ...
        [{ text: $lang_system.resources.tree.text_menu_edit, click: editNode  },
        { text: $lang_system.resources.tree.text_menu_del, click: delNode },
        { text: $lang_system.resources.tree.text_menu_editUrl, click: editUrl } ]
        });
	};
	...
	function moveNode(){
		...
		if(sourceId==rootId){
			$.ligerDialog.warn($lang_system.resources.tree.warn_msg_root,$lang.tip.warn);
			return;
		}
	...
	function delNode(){
		...
		$.ligerDialog.confirm($lang.operateTip.sureDelete,$lang.tip.confirm,callback);
	};
	//
	function editUrl(){
		var selectNode=getSelectNode();
...
<body>
<div id="layout">
	<div position="left" title="<spr:message code='res.res.man'/>" style="text-align: left;" >
		<div style="width:100%;">
