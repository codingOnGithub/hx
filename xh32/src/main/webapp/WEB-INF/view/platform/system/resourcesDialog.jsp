	...
	<script type="text/javascript">
		...
		function selectIcon(){
			...
			if(selected.length==0){
				$.ligerDialog.success($lang_system.resources.dialog.noPicture,$lang.tip.msg);
				return ;
			}
		...
		function loadMenu(){
			menu= $.ligerMenu({top: 100, left: 100, width: 120, items:
				[{text:$lang_system.resources.dialog.createFolder,click:createFolder},
				 {text:$lang_system.resources.dialog.delFolder,click:delFolder}
				]
			});
		}
...
<body style="margin:0 0 0 0;padding: 0 0 0 0;">
	<div id="defLayout">
		<div  position="left" title="<spr:message code='res.res.man'/>" style="overflow: auto; float: left;width: 100%;">
			<div class="tree-toolbar">
				<span class="toolBar">
					<div class="group">
						<a class="link reload" id="treeFresh" href="javascript:loadTree();"><span></span><spr:message code="menu.button.refresh" /></a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group">
						<a class="link expand" id="treeExpandAll"
							href="javascript:treeExpandAll(true)"><span></span><spr:message code="menu.button.expand"/></a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group">
						<a class="link collapse" id="treeCollapseAll" href="javascript:treeExpandAll(false)"><span></span><spr:message code="menu.button.collapse"/></a>
					</div>
				</span>
			</div>
	...
	<div position="bottom"  class="bottom" style='margin-top:5px;'>
		<a href='#' class='button' onclick="selectIcon()" ><span><spr:message code="operator.select"/></span></a>
		<a href='#' class='button' style='margin-left:10px;'  onclick="window.close()"><span><spr:message code="operator.cancel"/></span></a>
	</div>
</body>
</html>