...
<title><spr:message code="sysFile"/><spr:message code="title.dialog"/></title>
...
<body>
	<div id="defLayout" style="height:100%;">
		 <div position="left" title="<spr:message code="sysFile.dialog.typeTree"/>" style="overflow: auto;float:left;width:210px;height:92%;">
            	<div class="tree-toolbar">
					<span class="toolBar">
						<div class="group"><a class="link reload" id="treeFresh" href="javascript:void(0);" onclick="globalType.loadGlobalTree();return false;" title="<spr:message code="menu.button.refresh"/>" ></a></div>
						<div class="l-bar-separator"></div>
						<div class="group"><a class="link expand" id="treeExpandAll" href="javascript:void(0);" onclick="treeExpandAll(true);return false;" title="<spr:message code="menu.button.expand"/>"></a></div>
						<div class="l-bar-separator"></div>
						<div class="group"><a class="link collapse" id="treeCollapseAll" href="javascript:void(0);" onclick="treeExpandAll(false);return false;" title="<spr:message code="menu.button.collapse"/>" ></a></div>	
					</span>
				</div>
		...
		<div class="l-layout-header"><spr:message code="sysFile.dialog.typeList"/></div>			
		...
		<c:if test="${isSingle == 0}">
			<div position="right" title="<span><a onclick='javascript:dellAll();' class='link del'><spr:message code='sysFile.dialog.clear'/></a><input type='text' class='quick-find' title='查找'/></span>" style="height:92%;overflow:auto;">
		...
		<div position="bottom"  class="bottom" >
				<a href='#' class='button'  onclick="fileUpload();" ><span class="icon upload"></span><span class="chosen"><spr:message code="operator.upload"/></span></a>
				<a href='#' class='button' style='margin-left:10px;'  onclick="selectFile()" ><span class="icon ok"></span><span class="chosen"><spr:message code="operator.select"/></span></a>
				<a href='#' class='button' style='margin-left:10px;'  onclick="window.close()"><span class="icon cancel"></span><span class="chosen"><spr:message code="operator.cancel"/></span></a>
		</div>
	</div>
	<textarea id="trTemplate" style="display: none;">
		<tr id="file_#fileId">
			...
			<td>
				<a onclick="javascript:delRow(this);" class="link del"><spr:message code="operator.del"/></a> 
			</td>
		</tr>
	</textarea>
</body>
