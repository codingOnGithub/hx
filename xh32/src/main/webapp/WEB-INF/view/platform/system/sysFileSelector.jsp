...
<title><spr:message code="sysFile"/><spr:message code="title.selector"/></title>
...
<body >
	<div class="panel">
		...
		<div class="tbar-title">
			<span class="tbar-label"><spr:message code="sysFile"/><spr:message code="title.selector"/></span>
		</div>
	...
	<div class="panel-body">
		...
		<display:table name="sysFileList" id="sysFileItem" requestURI="selector.ht" sort="external" cellpadding="1"
			...
			<display:column titleKey="sysFile.fileName" sortable="true" sortName="fileName">
				${sysFileItem.fileName}.${sysFileItem.ext}
			</display:column>
			<display:column property="ext" titleKey="sysFile.ext" sortable="true" sortName="ext" />
		</display:table>
