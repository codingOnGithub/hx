...
<title><spr:message code="reportTemplate.manage.title" /></title>
...
<script type="text/javascript">
	...
	function zTreeOnRightClick(event, treeId, treeNode) {
     ...
     function handler(item){
     	...
     	var txt=item.text;
     	switch(txt){
     		case $lang_system.globalType.tree.reportTypeMenu.text_menu_add:
     			globalType.openGlobalTypeDlg(true);
     			break;
     		case $lang_system.globalType.tree.reportTypeMenu.text_menu_edit:
     			globalType.openGlobalTypeDlg(false);
     			break;
     		case $lang_system.globalType.tree.reportTypeMenu.text_menu_del:
     			globalType.delNode();
     			break;
     	}
     }
...
<body>
    ...
    <div id="defLayout" >
		<div position="left" title="<spr:message code='reportTemplate.manage.leftTitle' />" style="overflow: auto;float:left;width:100%">
		...
		<div position="center" title="<spr:message code='reportTemplate.manage.centerTitle' />">
