...
<html>
	<head>
		...
		<title><spr:message code="sysRole.selector.title"/></title>
	...
	<body >
		...
		<div position="bottom"  class="bottom" style="margin-top:10px;" >
		      	<a href="#" class="button"  onclick="selectRole()" style="margin-right:10px;" ><span class="icon ok"></span><span class="chosen"><spr:message code="menu.button.choose"/></span></a>
				<a href="#" class="button"  onclick="clearRole()"><span class="icon cancel" ></span><span class="chosen" ><spr:message code="menu.button.clean"/></span></a>
