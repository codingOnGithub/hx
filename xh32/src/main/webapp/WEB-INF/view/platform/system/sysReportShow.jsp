...
<title><spr:message code="sysReport.show.title" /></title>
</head>
<body>
<div class="panel-top">
	<div class="panel-toolbar">
		<div class="toolBar area-export">
			<div class="group exportlinks" title="<spr:message code='sysReport.exportPDF' />" onclick="save('pdf')">
				<div class="pdf" style="width:40px;">PDF</div>
			</div>
			<div class="l-bar-separator"></div>
			<div class="group exportlinks" title="<spr:message code='sysReport.exportEXCEL' />" onclick="save('xls')">
				<div class="excel">EXCEL</div>
			</div>
			<div class="l-bar-separator"></div>
			<div class="group exportlinks" title="<spr:message code='sysReport.exportWORD' />" onclick="save('doc')">
				<div class="rtf">WORD</div>
			</div>
			<div class="l-bar-separator"></div>
			<div class="group" title="<spr:message code='menu.button.print' />">
				<a id='print' class="link print" style="background:url('') !important;"/><span></span><spr:message code="menu.button.print" /></a>
			</div>
			<div class="l-bar-separator"></div>
			<div class="group" title="<spr:message code='menu.button.search' />">
				<a id="search" class="link search" style="background:url('') !important;"/>
					<span style="height:16px"></span><spr:message code="menu.button.search" />
				</a>
			</div>
			<!--右侧布局 -->
			...
			<div class="group leftGroup">
				<div class="l-bar-button l-bar-btnnext">
					<a href="#" onclick="next('')" title="<spr:message code='paging.nextPage' />"> <span></span>
					</a>
				</div>
				<div class="l-bar-button l-bar-btnlast">
					<a href="#" onclick="last('')" title="<spr:message code='paging.lastPage' />">
						<span></span>
					</a>
				</div>
			</div>
			...
			<div class="group leftGroup">
				<div class="l-bar-button l-bar-btnfirst">
					<a href="#" onclick="first('')" title="<spr:message code='paging.firstPage' />"> <span class=""></span>
					</a>
				</div>
				<div class="l-bar-button l-bar-btnprev">
					<a href="#" onclick="previous('')" title="<spr:message code='paging.prevPage' />"> 
					<span class=""></span>
					</a>
				</div>
			</div>
			<div class="group l-bar-selectpagesize leftGroup">
				<spr:message code="paging.perPageSize" />&nbsp;<select id="pageSize" name="pageSize" onchange="changePageSize(this,'');" class="select_short">
