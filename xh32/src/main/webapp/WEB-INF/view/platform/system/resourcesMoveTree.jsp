...
<script type="text/javascript">
	...
	function selectNode(){
		if(!targetNode){
			$.ligerDialog.warn($lang_system.resources.moveTree.nullNode,$lang.tip.warn);
			return;
		}
...
<body>
	<div id="layout">
		<div title="<spr:message code='res.res.target'/>" position="center">
			<div id="resourcesTree" class="ztree" style="overflow:auto;"></div>
		</div>
	</div>
	<div position="bottom"  class="bottom" style="margin-top:10px;">
		<a href="#" class="button"  onclick="selectNode()" style="margin-right:10px;" ><span class="icon ok"></span><span ><spr:message code="operator.select"/></span></a>
