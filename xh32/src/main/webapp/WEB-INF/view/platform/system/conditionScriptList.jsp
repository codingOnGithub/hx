...
<title><spr:message code="conditionScript"/><spr:message code="operator.manageList"/></title>
<style type="text/css">
	html,body{
		overflow:auto;
	}
	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="conditionScript"/><spr:message code="operator.manageList"/></span>
			</div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="conditionScriptList" id="conditionScriptItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column titleKey="conditionScript.methodName" sortable="true" sortName="METHOD_NAME">
