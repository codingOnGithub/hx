...
<title><spr:message code="calendarAssign.edit.title" /></title>
	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="calendarAssign.edit.span" /></span>
			</div>
		...
		<div class="panel-body">
			...
			<form id="calendarAssignForm" method="post" action="save.ht">
				<table class="table-detail" cellpadding="0" cellspacing="0"
					border="0">
					<tr>
						<th width="20%"><spr:message code="calendarAssign.calendar" />:</th>
