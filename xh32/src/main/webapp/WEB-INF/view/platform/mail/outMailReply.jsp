		...
		<div class="panel">
			<div class="panel-top">
				<div class="tbar-title">
					<span class="tbar-label"><spr:message code="outMailReply.title"/>回复邮件</span>
				</div>
			<div class="panel-toolbar">
				<div class="toolBar">
				    <div class="group"><a class="link save"><span></span><spr:message code="outMailReply.sending"/></a></div>
					<div class="l-bar-separator"></div>
				    <div class="group"><a class="link init" id="dataFormDraft"><span></span><spr:message code="outMailReply.saveDraft"/></a></div>
					<div class="l-bar-separator"></div>
				    <div class="group"><a class="link back" href="get.ht?mailId=${outMail.mailId}&outMailSetId=${outMailSetId}"><span></span><spr:message code="menu.button.back"/></a></div>
				</div>
			</div>
			</div>
