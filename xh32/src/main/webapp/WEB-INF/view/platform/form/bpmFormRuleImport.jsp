...
<title><spr:message code="bpmFormRule.title"/><spr:message code="operator.import"/></title>
	...
	$(function(){
		...
		$("#btnSave").click(function(){
			...
			if(extNaem!='xml'){
				$.ligerDialog.warn($lang_form.imp.selectXml,$lang.tip.warn);
			}else{
	...
	function showResponse(responseText){
		...
		if(obj.isSuccess()){//成功
	    	...
	    	$.ligerDialog.err($lang.tip.error,$lang_form.imp.failure,obj.getMessage());
	    }
	}
...
<div class="panel">
	<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="bpmFormRule.title"/><spr:message code="operator.import"/></span>
			</div>
