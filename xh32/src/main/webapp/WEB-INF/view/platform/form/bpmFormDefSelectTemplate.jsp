...
<title><spr:message code="bpmFormDef.selectTemplate"/></title>
<style type="text/css">
	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="bpmFormDef.selectTemplate"/></span>
			</div>
		...
		<div class="panel-body">
			<form id="frmDefInfo">
					...
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<th width="30%"><spr:message code="bpmFormDef.mainTemplate"/>:</th>
							<td>
						...
						<tr>
							<th width="30%">${subTable.tableDesc }<spr:message code="bpmFormDef.subTemplate"/>:</th>
							<td>
