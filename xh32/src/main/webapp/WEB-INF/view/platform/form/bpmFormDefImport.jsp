...
<title><spr:message code="bpmFormDef.title"/><spr:message code="operator.import"/></title>
...
<body>
	<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="bpmFormDef.title"/><spr:message code="operator.import"/></span>
			</div>
