...
<script type="text/javascript">
	...
	function onChecked(obj,tr,textarea) {
		...
		if (existsIndex == -1 && (checked == true || checked == 'checked')) {
			...
			$(copyTr.find('td')[0]).html('<a class="link del" href="#" title="'+$lang.button.del+'"></a>');
	...
	<div class="panel hidden">
		<div>
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link back" id="btnBack" onclick="back()"><span></span><spr:message code="menu.button.back"/></a></div>
				</div>
			</div>
		</div>
