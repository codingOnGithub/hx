...
<html>
<head>
	<title><spr:message code="bpmFormDialog.title"/></title>
		...
		<c:when test="${bpmFormDialog.style==1}">
			...
			<script type="text/javascript">
				...
				function  zTreeOnClick(event, treeId, treeNode) {
					if(!isMuliti){
						parent.parent.__resultData__=getResult();
					}
				};
											...
											<c:otherwise>
												...
												<c:choose>
													...
													<c:when test="${col.paraCt=='4'}">
														<a href="#" class="link user" name="${col.fieldName}"><spr:message code="bpmFormDialog.userType.user"/></a>
													</c:when>
													<c:when test="${col.paraCt=='17'}">
														<a href="#" class="link role" name="${col.fieldName}"><spr:message code="bpmFormDialog.userType.role"/></a>
													</c:when>
													<c:when test="${col.paraCt=='18'}">
														<a href="#" class="link org" name="${col.fieldName}"><spr:message code="bpmFormDialog.userType.org"/></a>
													</c:when>
													<c:when test="${col.paraCt=='19'}">
														<a href="#" class="link pos" name="${col.fieldName}"><spr:message code="bpmFormDialog.userType.pos"/></a>
													</c:when>
												</c:choose>
											</c:otherwise>
										</c:choose>
