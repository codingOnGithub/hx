...
<title><spr:message code="script.conditionScript"/></title>
	...
	<div class="panel" >
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label"><spr:message code="script.conditionScript"/></span>
			</div>
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="tipbox"><a href="#" class="tipinfo"><span><spr:message code="bpmDataTemplate.script.tipinfo"/>,<br/>例：1.BPM_BUS_LINK.BUS_CREATOR_ID=:[CUR_USER]<br/>2.table.field  like '%value%'</span></a></div>
				</div>
			</div>
		</div>
		<div class="panel-body">
			<form id="scriptForm" method="post" action="save.ht">			
					<table class="table-detail" cellpadding="1" cellspacing="1" border="0"  >
						<tr>
							<td width="40%"><spr:message code="bpmFormDialog.setting.field"/>：
							...
							<td>
								<spr:message code="bpmDataTemplate.field.common"/>：
								<select id="commFieldSelect" class="left margin-set" name="commFields" onchange="commFieldChange.apply(this)">
									<option value="">--<spr:message code="search.select.pleaseSelect"/>--</option>
									<option value="[CUR_USER]"><spr:message code="bpmDataTemplate.curUser"/></option>
									<option value="[CUR_ORG]"><spr:message code="bpmDataTemplate.curOrg"/></option>
								</select>
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<spr:message code="bpmDataTemplate.table.using"/>:<input type="checkbox" value="${bpmFormTable.tableName}" name="tables"  maintable="${bpmFormTable.tableName}" relation="${bpmFormTable.relation}"  source="1" >${bpmFormTable.tableDesc}
								<c:forEach items="${bpmFormTable.subTableList}" var="subTable">
