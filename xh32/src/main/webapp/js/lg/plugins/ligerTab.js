...
(function ($)
{
    ...
    $.ligerDefaults.TabString = {
        closeMessage: $lang_js.ligertab.closeMessage,
        closeOtherMessage:  $lang_js.ligertab.closeOtherMessage,
        closeAllMessage:  $lang_js.ligertab.closeAllMessage,
        reloadMessage:  $lang_js.ligertab.reloadMessage
    };
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            g.tab.links = $('<div class="l-tab-links"><ul style="left:5"></ul></div>');
        ...
        setTabButton: function ()
        {
            ...
            {
                g.tab.links.ul.animate({ left: 30 });
        ...
        moveToPrevTabItem: function ()
        {
            ...
            for (var i = 0; i < leftList.length - 1; i++)
            {
                ...
                {
                    g.tab.links.ul.animate({ left: -1 * (parseInt(leftList[i])-30) });
                    return;
                }
            }
        },
        ...
        moveToNextTabItem: function ()
        {
            ...
            for (var j = 1; j < leftList.length; j++)
            {
                ...
                {
                    g.tab.links.ul.animate({ left: -1 * (parseInt(leftList[j - 1])+30) });
                    return;
                }
            }
        },
...
//            $("> .l-tab-content-item[tabid=" + tabid + "]", g.tab.content).show().siblings().hide();
        ...
        moveToLastTabItem: function ()
        {
            ...
            if (sumwidth > mainwidth)
            {
                ...
                g.tab.links.ul.animate({ left: -1 * (sumwidth - mainwidth + btnWitdth + 30) });
            }
        },
        //判断tab是否存在
