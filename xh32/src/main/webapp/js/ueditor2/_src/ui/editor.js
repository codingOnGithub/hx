    	    		...
    	    		if(ifEl||ifElParent){
    	    			if(readOnly){
    	    				if(isflag){
		                       ...
		                       '<nobr>'+editor.getLang("property")+': <span onclick="$$._onInputCutButtonClick(event, this);" class="edui-clickable">'+editor.getLang("cut")+'</span>&nbsp;&nbsp;'+
		                        '<span onclick="$$._unReadOnlyClick(event, this);" class="edui-clickable">'+editor.getLang("deleteReadonly")+'</span>&nbsp;&nbsp;'+
		                       '</nobr>' );
    	    				}else{
    	    				 var html = popup.formatHtml(
		                       ...
		                       '<span onclick="$$._onInputCutButtonClick(event, this);" class="edui-clickable">'+editor.getLang("cut")+'</span>&nbsp;&nbsp;'+
		                        '<span onclick="$$._unReadOnlyClick(event, this);" class="edui-clickable">'+editor.getLang("deleteReadonly")+'</span>&nbsp;&nbsp;'+
		                       '</nobr>' );
    	    				}
    	    			}else{
    	    				if(isflag){
    	    					var html = popup.formatHtml(
		                       '<nobr>'+editor.getLang("property")+': <span onclick="$$._onInputCutButtonClick(event, this);" class="edui-clickable">'+editor.getLang("cut")+'</span>&nbsp;&nbsp;'+
		                        '<span onclick="$$._onReadOnlyClick(event, this);" class="edui-clickable">'+editor.getLang("setReadonly")+'</span>&nbsp;&nbsp;'+
		                       '</nobr>' );
    	    				}else{
    	    				 var html = popup.formatHtml(
		                       '<nobr>'+editor.getLang("property")+': <span onclick="$$._onInputDelButtonClick()" class="edui-clickable">'+editor.getLang("delete")+'</span>&nbsp;&nbsp;' +	                       
    				   ...
    				   if(isSelect){
	    				   	...
	    				   	if(isCascadequery){
	    	                       ...
	    	                       '<span onclick="$$._onInputEditButtonClick(event, this);" class="edui-clickable">' + editor.getLang("modify") + '</span>&nbsp;&nbsp;'+
	    	                       '<span onclick="$$._onInputCutButtonClick(event, this);" class="edui-clickable">'+editor.getLang("cut")+'</span>&nbsp;&nbsp;'+
	    	                       '<span onclick="$$._onCascadeQueryClick(event, this);" class="edui-clickable">'+editor.getLang("cascadeSetting")+'</span>&nbsp;&nbsp;' +
	    	                       '<span onclick="$$._onUnCascadeQueryClick(event, this);" class="edui-clickable">'+editor.getLang("deleteCascade")+'</span>&nbsp;&nbsp;'+
	    	                       '</nobr>' );
	    				   	}else{
	    				   		html = popup.formatHtml(
    	                       '<nobr>'+editor.getLang("property")+': <span onclick="$$._onInputDelButtonClick()" class="edui-clickable">'+editor.getLang("delete")+'</span>&nbsp;&nbsp;' +	                       
