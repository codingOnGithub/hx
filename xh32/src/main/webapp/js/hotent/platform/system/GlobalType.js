...
function clickHandler(item){
	...
	if(txt==$lang_js.globalType.menu.addType){
		addNode();
	}else if(txt==$lang_system.globalType.tree.globalMenu.text_menu_export){
		exportNode();
	}else if(txt==$lang_system.globalType.tree.globalMenu.text_menu_import){
		importNode();
	}else if(txt==$lang_system.globalType.tree.globalMenu.text_menu_sort){
		sortNode();
	}else if(txt==$lang_system.globalType.tree.globalMenu.text_menu_del){
		delNode();
	}
	else if(txt==$lang_system.globalType.tree.globalMenu.text_menu_refresh){
...
function delNode(){
	...
	$.ligerDialog.confirm($lang_system.globalType.confirm,$lang.tip.confirm,callback);
};
