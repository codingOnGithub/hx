...
OfficeControl=function(){
	{
		...
		this.config={doctype:'doc',fileId:"",controlId:"officeObj",myNum:'0'};
	};
	/**
	 * 处理文件菜单事件。
	 */
	...
	this.getControlHtml=function(controlId){
			...
			var str = '';
			if (Sys.ie) {
				str = '<object  id="'+controlId+'" codeBase="'+cabPath+'" height="'+this.height+'" width="'+this.width+'" classid="clsid:C9BC4DFF-4248-4a3c-8A49-63A7D317F404" style="z-index:-1;">';
			...
			//	str +='<param name="TitlebarColor" value="15658734">   ';
				...
				str +='clsid="{C9BC4DFF-4248-4a3c-8A49-63A7D317F404}" >';
		//		str +='<SPAN STYLE="color:red">尚未安装NTKO Web FireFox跨浏览器插件。请点击<a href="ntkoplugins.xpi">安装组1件</a></SPAN>   ';
				str +='</object>  ';				
			} else if (Sys.chrome) {
				str ='<object id="'+controlId+'" clsid="{C9BC4DFF-4248-4a3c-8A49-63A7D317F404}"  ForOnSaveToURL="saveMethodOnComplete" ForOnAddTemplateFromURL="addTemplateOnComplete'+ this.config.myNum +'" ';
				str +='ForOnpublishAshtmltourl="publishashtml"	';
				str +='ForOnpublishAspdftourl="publishaspdf"	';
				str +='ForOnSaveAsOtherFormatToUrl="saveasotherurl"	';
				str +='ForOnDoWebGet="dowebget"	';
