...
function setFieldByValueFrom(field){
	...
	switch(from){
		...
		case 3:
			...
			field.identityName=$("#identityName").val();
			break;
	}
}
...
//	$("#ccisread").attr("checked",field.ccisread==1);
	...
	hdlIdentityTrShow(ft,vf,ct,field.identity,field.identityName);
...
function hdlControlTypeShow(ft,vf,value){
	...
	case date_://日期
		...
		case '0'://表单输入
			controlTypeTr.show();
			controlList = [ {key : '1',value : $lang_form.editTable.control.text},{key : '15',value : $lang_form.editTable.control.datepicker}];
			break;
		case '1'://脚本输入 (显示)
		case '2'://脚本输入 (隐藏)
		case '3'://流水号
	...
	case number_://数字
		...
		case '0'://表单输入
			controlTypeTr.show();
			controlList =[ {key : '1',value : $lang_form.editTable.control.text},
                    {key : '11',value : $lang_form.editTable.control.select}
                    ];
			break;
		case '1'://脚本输入 (显示)
		case '2'://脚本输入 (隐藏)
			controlTypeTr.show();
			controlList = [ {key : '1',value : $lang_form.editTable.control.text},{key : '16',value : $lang_form.editTable.control.hidedomaid}];
			break;
		case '3'://流水号
			break;
		}
