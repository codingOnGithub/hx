...
Permission=function(){
	...
	this.load=function(url,params){
		...
		var _self=this;
		$.ligerDialog.waitting($lang_form.permission.waiting_msg);
	...
	this.getPermission=function(aryPermission,type){
		...
		if(type=='subtable'){
			for(var i=0;i<aryPermission.length;i++){
				...
				subTableHtml += '<tr><th colspan="4">'+tablePermission.memo+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" value="w" name="radio_'+tablePermission.tableId+'" id="radio_'+tablePermission.tableId+'" checked="checked" ><label for="SubtableShow">'+$lang_form.permission.edit+'</label>';
				subTableHtml += '&nbsp;&nbsp;<input type="radio" value="b" name="radio_'+tablePermission.tableId+'" id="radio_'+tablePermission.tableId+'"><label for="SubtableShow">'+$lang_form.permission.required+'</label>';
				subTableHtml += '&nbsp;&nbsp;<input type="radio" value="r" name="radio_'+tablePermission.tableId+'" id="radio_'+tablePermission.tableId+'"><label for="SubtableShow">'+$lang_form.permission.readonly+'</label>';
				subTableHtml += '&nbsp;&nbsp;<input type="radio" value="y" name="radio_'+tablePermission.tableId+'" id="radio_'+tablePermission.tableId+'"><label for="SubtableShow">'+$lang_form.permission.hidden+'</label></th></tr>';
	...
	this.getHtmlTd=function(v,full,type){
		...
		var aryTd = ['<td'+tdstr+'>'
			...
			, '<option value="user">',$lang_form.permission.user,'</option>'
			, '<option value="role">',$lang_form.permission.role,'</option>'
			, '<option value="org">',$lang_form.permission.org,'</option>'
			, '<option value="orgMgr">',$lang_form.permission.orgMgr,'</option>'
			, '<option value="pos">',$lang_form.permission.pos,'</option>'
			, '<option value="everyone">',$lang_form.permission.everyone,'</option>'
			, '<option value="none">',$lang_form.permission.none,'</option>'
			, '</select>'
			, '<span name="',v,'_span">'
			, '<input  type="hidden"  value="#',uv,'_ID"/>'
			, '<input  type="text"  readonly value="#',uv,'_FullName"/>'
			, '<a href="#" class="link-get" mode="',full,'" ><span class="link-btn">'+$lang.button.select+'</span></a>'
			, '</span>'
			, '</td>'];
		return aryTd.join('');
	};
