		...
		if(data){
			var callBack=function(rtn){
				...
				$.post(flowUrl,parameters,function(responseText){
					...
					if(obj.isSuccess()){//成功
						$.ligerDialog.success($lang_js.bpm.flowUtil.startFlow.success,$lang.tip.msg);
					}
					else{
						$.ligerDialog.error($lang_js.bpm.flowUtil.startFlow.failure,$lang.tip.errorMsg);
					}
				});
			};
			$.ligerDialog.confirm($lang_js.bpm.flowUtil.startFlow.confirmRun,$lang.tip.confirm,callBack);
		}else{
