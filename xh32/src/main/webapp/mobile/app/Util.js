 ...
 *            conf
 */
HTUtil.showErrorInfo = function(conf) {
	if (Ext.isEmpty(conf))
		return;
	HT.loadMask();
	Ext.Ajax.request({
				url : 'platform/system/sysErrorLog/getErrorInfo.ht',
				params : {
					id : conf.id
				},
				scope : this,
