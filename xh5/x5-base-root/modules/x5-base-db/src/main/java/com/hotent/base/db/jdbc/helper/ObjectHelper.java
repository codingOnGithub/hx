...
import com.hotent.base.db.annotation.ClassDescription;
import com.hotent.base.db.annotation.FieldDescription;
...
public class ObjectHelper<T> {
	...
	public String getTableName() {
		...
		ClassDescription clsDesc = (ClassDescription) cls
				.getAnnotation(ClassDescription.class);
		if (clsDesc == null)
	...
	public List<ColumnModel> getColumns() {
		...
		for (int i = 0; i < fields.length; i++) {
			...
			FieldDescription fldDesc = fld
					.getAnnotation(FieldDescription.class);
			if (fldDesc == null) {
	...
	public String getAddSql() {
		...
		sb.append("insert into ").append(tableName).append("(")
				.append(aryCol[0]).append(")").append(" values (")
				.append(aryCol[1]).append(")");
		return sb.toString();
	}
