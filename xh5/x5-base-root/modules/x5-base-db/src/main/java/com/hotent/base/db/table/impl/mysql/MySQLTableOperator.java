...
public class MySQLTableOperator extends BaseTableOperator {
	...
	public void updateColumn(String tableName, String columnName, Column column)
		...
		sb.append("ALTER TABLE ")
				.append(tableName)
				.append(" CHANGE " + columnName + " " + column.getName())
				.append(" ")
				.append(getColumnType(column.getColumnType(),
	...
	public List<String> getPKColumns(String tableName) throws SQLException {
		...
		String sql = "SELECT k.column_name "
				...
				+ "AND t.table_schema='" + schema + "' " + "AND t.table_name='"
				+ tableName + "'";
	...
	public boolean isTableExist(String tableName) {
		String schema = getSchema();
		String sql = "select count(1) from information_schema.TABLES t where t.TABLE_SCHEMA='"
				+ schema
				+ "' and table_name ='"
