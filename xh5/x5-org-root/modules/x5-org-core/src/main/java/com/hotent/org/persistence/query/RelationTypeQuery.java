...
public class RelationTypeQuery {
	...
	public static class UpdateClause {
		...
		public void setType(Type type) {
			dataClauses.add(new SetData("type_ = ", type));
		}

		public void setConstType(ConstType constType) {
			dataClauses.add(new SetData("const_type_ = ", constType));
		}

		public void setCurrentName(String currentName) {
			dataClauses.add(new SetData("current_name_ = ", currentName));
		}

		public void setRelName(String relName) {
			dataClauses.add(new SetData("rel_name_ = ", relName));
		}
		...
		public void setMemo(String memo) {
			dataClauses.add(new SetData("memo_ = ", memo));
		}
		...
		public void setIsBidirectonal(String isBidirectonal) {
			dataClauses.add(new SetData("is_bidirectonal = ", isBidirectonal));
		}
