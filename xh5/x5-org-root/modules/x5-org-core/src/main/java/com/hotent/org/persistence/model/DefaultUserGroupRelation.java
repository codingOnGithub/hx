 ...
 */
public class DefaultUserGroupRelation extends AbstractModel<String> implements UserGroupRelation{
	...
	protected Status  status; /*状态。actived=正常；forbidden=禁用；archives=归档（历史关系）*/
