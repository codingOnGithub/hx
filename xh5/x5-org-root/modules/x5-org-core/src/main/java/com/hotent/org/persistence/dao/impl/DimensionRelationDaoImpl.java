...
public class DimensionRelationDaoImpl extends MyBatisDaoImpl<String, DefaultDimensionRelation> implements DimensionRelationDao{
	...
	@Override
	public List<DefaultDimensionRelation> queryByCriteria(DimensionRelationQuery.FindQuery query) {
		return this.getByKey("queryByCriteria", query);
	}
	
	
	@Override
	public List<DefaultDimensionRelation> queryByCriteria(DimensionRelationQuery.FindQuery query, Page page) {
		return this.getByKey("queryByCriteria", query, page);
	}

	@Override
	public long queryCountByCriteria(DimensionRelationQuery.FindQuery query) {
		return (Long) this.getOne("queryCountByCriteria", query);
	}
	
	@Override
	public void updateByUpdateQuery(DimensionRelationQuery.UpdateQuery uQuery){
		this.updateByKey("updateByUpdateQuery",uQuery);
	}

	
	@Override
	public void deleteByDeleteQuery(DimensionRelationQuery.DeleteQuery dQuery) {
