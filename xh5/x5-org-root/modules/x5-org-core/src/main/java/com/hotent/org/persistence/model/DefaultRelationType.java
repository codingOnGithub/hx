...
public class DefaultRelationType extends AbstractModel<String> implements RelationType{
	...
	protected Type  type; /*关系归属。用户关系=user；用户组关系=group；用户与组关系=usergroup*/
	protected ConstType  constType; /*关系约束类型。1对1=one2one；1对多=one2many；多对1=many2one；多对多=many2many*/
	...
	protected Status  status; /*关系状态。actived=正常；forbidden=禁用*/
	...
	protected IsBidirection  isBidirectional = IsBidirection.Y; /*是否是双向*/
	...
	public void setIsBidirectonal(IsBidirection isBidirectional) 
	{
	 ...
	 * @return
	 */
	public IsBidirection getIsBidirectonal() 
	{
	...
	public String toString() 
	{
		...
		.append("isBidirectonal", this.isBidirectional) 
		.toString();
	}
}