...
public abstract class AttributeValueQuery {
    ...
    public static class UpdateClause {
    	...
    	public void setAttrId(String attrId){
    		dataClauses.add(new SetData("attr_id_ = ",attrId));
    	}
    	...
    	public void setTextVal(String textVal){
    		dataClauses.add(new SetData("text_val = ",textVal));
    	}

    	public void setDateVal(Date dateVal){
    		dataClauses.add(new SetData("date_val = ",dateVal));
    	}

    	public void setLongVal(Long longVal){
    		dataClauses.add(new SetData("long_val = ",longVal));
    	}

    	public void setDecVal(Double decVal){
    		dataClauses.add(new SetData("dec_val = ",decVal));
    	}
