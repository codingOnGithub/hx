...
public class UserGroupRelationDaoImpl extends MyBatisDaoImpl<String, DefaultUserGroupRelation> implements UserGroupRelationDao{
	...
	@Override
	public List<DefaultUserGroupRelation> queryByCriteria(UserGroupRelationQuery query) {
		return this.getByKey("queryByCriteria", query);
	}
	
	
	@Override
	public List<DefaultUserGroupRelation> queryByCriteria(UserGroupRelationQuery query, Page page) {
		return this.getByKey("queryByCriteria", query, page);
	}

	@Override
	public long queryCountByCriteria(UserGroupRelationQuery query) {
		return (Long) this.getOne("queryCountByCriteria", query);
	}
	
	
	@Override
	public void updateByUpdateQuery(UserGroupRelationUpdateQuery uQuery){
	...
	@Override
	public void deleteByDeleteQuery(UserGroupRelationDeleteQuery dQuery){
