...
public class RankTypeUpdateQuery {
    ...
    public static class UpdateClause {
    	...
    	protected UpdateClause() {
    		this.dataClauses = new ArrayList<RankTypeUpdateQuery.DataClause>();
		}
    	...
    	public void setLevel(Integer level){
    		dataClauses.add(new DataClause("level_ = ",level));
    	}
