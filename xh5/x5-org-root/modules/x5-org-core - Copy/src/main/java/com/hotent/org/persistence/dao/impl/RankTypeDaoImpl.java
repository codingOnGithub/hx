...
public class RankTypeDaoImpl extends MyBatisDaoImpl<String, DefaultRankType> implements RankTypeDao{
	...
	@Override
	public List<DefaultRankType> queryByCriteria(RankTypeQuery query) {
		return this.getByKey("queryByCriteria", query);
	}
	
	
	@Override
	public List<DefaultRankType> queryByCriteria(RankTypeQuery query, Page page) {
		return this.getByKey("queryByCriteria", query, page);
	}

	@Override
	public long queryCountByCriteria(RankTypeQuery query) {
		return (Long) this.getOne("queryCountByCriteria", query);
	}
	
	@Override
	public void updateByUpdateQuery(RankTypeUpdateQuery uQuery){
		this.updateByKey("updateByUpdateQuery",uQuery);
	}

	
	@Override
	public void deleteByDeleteQuery(RankTypeDeleteQuery dQuery) {
