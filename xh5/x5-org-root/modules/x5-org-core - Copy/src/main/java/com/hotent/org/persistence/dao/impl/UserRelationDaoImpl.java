...
public class UserRelationDaoImpl extends MyBatisDaoImpl<String, DefaultUserRelation> implements UserRelationDao{
	...
	@Override
	public List<DefaultUserRelation> queryByCriteria(UserRelationQuery query) {
		return this.getByKey("queryByCriteria", query);
	}
	@Override
	public List<DefaultUserRelation> queryByCriteria(UserRelationQuery query, Page page) {
