...
import com.hotent.org.persistence.query.UserRelationQuery.Criteria;

public class UserRelationUpdateQuery {
    ...
    public UserRelationUpdateQuery() {
    ...
    public static class UpdateClause {
    	...
    	public UpdateClause() {
			this.dataClauses = new ArrayList<UserRelationUpdateQuery.DataClause>();
		}
    	...
    	public void setRelUserId(String relUserId){
    		dataClauses.add(new DataClause("rel_user_id_ = ",relUserId));
    	}
