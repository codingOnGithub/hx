...
public class Resources
{
	...
	protected Long menuResId;
	protected String menuLan;
	protected String menuMsg;
	protected String menuMemo;
	...
	public void setMenuResId(Long menuResId) {
		this.menuResId = menuResId;
	}
	public String getMenuLan() {
		return menuLan;
	}
	public void setMenuLan(String menuLan) {
		this.menuLan = menuLan;
	}
