...
<body>
	<div id="defLayout" style="height:100%;">
		<div id="leftMemu" position="left" title="<spr:message code='sysUser.dialog.title'/>" style="overflow: auto; float:left;width: 100%; height:95%">
			<div title="<spr:message code='sysUser.dialog.selByOrg'/>" style="overflow: hidden;">
			...
			<div title="<spr:message code='sysUser.dialog.selByPos'/>" style="overflow: hidden;">
				<table border="0" width="100%" class="table-detail">
					<tr >
						<td width="30%" nowrap="nowrap"><span class="label"><spr:message code="sysUser.dialog.dimension"/>:</span>
						</td>
			...
			<div title="<spr:message code='sysUser.dialog.selByRole'/>" style="overflow: hidden;">
			...
			<div title="<spr:message code='sysUser.dialog.selByOnLine'/>" style="overflow: hidden;">
		...
		<c:if test="${isSingle==false}">
			<div position="right" style="overflow:auto;height:95%;width:170px;"  title="<span><a onclick='javascript:dellAll();' class='link del'><spr:message code='menu.button.empty'/></a><input type='text' class='quick-find' title='<spr:message code='menu.button.search'/>'/></span>">
	...
	<div position="bottom"  class="bottom" style="margin-top:10px;">
		<a href="#" class="button"  onclick="selectUser()" style="margin-right:10px;" ><span class="icon ok"></span><span ><spr:message code="menu.button.choose"/></span></a>
		<a href="#" class="button"  onclick="clearUser()"><span class="icon cancel" ></span><span class="chosen" ><spr:message code="menu.button.empty"/></span></a>
