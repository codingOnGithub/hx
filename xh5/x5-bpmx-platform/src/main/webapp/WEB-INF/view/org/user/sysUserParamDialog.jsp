...
<title><spr:message code="sysParam.userParam"/><spr:message code="adv.win.custom"/></title>
		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a onclick="addDiv(3)" class="link add"><span></span><spr:message code="menu.button.add"/></a></div>
